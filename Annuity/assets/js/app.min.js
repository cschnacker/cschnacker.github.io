...
function chart_S3C1(bFlag) {
    try {
        var data0=[ssc.getCaption('Annuity!$E$31')].concat(ssc.getValue('Annuity!$E$32:$E$73_numonly'));var data1=[ssc.getCaption('Annuity!$F$31')].concat(ssc.getValue('Annuity!$F$32:$F$73_numonly'));var data2=[ssc.getCaption('Annuity!$D$31')].concat(ssc.getValue('Annuity!$D$32:$D$73_numonly'));var labels=ssc.getValues(['Annuity!$C$32:$C$73'], '', ssc.label);
labels = labels.map(function(d){return eedatefmt([24,0], d);});var colors=['#c0504d','#9bbb59','#4f81bd'];
        var chart = c3.generate({
  "bindto": "#d-S3C1",
  "onresized": function() {resizeChart(this.api,this.api.element);},
  "onrendered": function(){var div = $('#d-S3C1'), width = div.children('svg').width(); $('#'+ $(div).attr('id')+ '-tools').css({'width': width});},
  "size": {
    "height": calculateChartHeight($('#d-S3C1'), 421, 291),
    "width": calculateChartWidth($('#d-S3C1'), 421, 291)
  },
  "padding": {
    "right": 17,
    "top": 10
  ...
  "data": {
    ...
    "type": "bar",
    "names": {data0 : ssc.getCaption('Annuity!$E$31'),data1 : ssc.getCaption('Annuity!$F$31'),data2 : ssc.getCaption('Annuity!$D$31')},
    "bar": {
      "width": {
        "ratio": 0.5
      }
  ...
  "axis": {
    ...
    "y": {
      "tick": {
        "format": function(d) {return eedatefmt([24,0], d);}
      }
    }
  },
  "grid": {
  ...
  "point": {
    "show": false
        ...
        function chart(id){ 
                var bFlag=false;if(!ssc.isEmpty(co)){try{chart_S3C1(bFlag);}catch(err){ssc.exHandler('S3C1');}        }}
...
(function (EE) {
    var narray = (function () {
        function narray(arr, from_x, from_y, to_x, to_y) {
            this.arr = arr;
            this.from_x = from_x;
            this.to_x = to_x;
            this.from_y = from_y;
    ...
    function naequal(a, b) {
        if (a.from_x !== b.from_x || a.to_x != b.to_x || a.from_y !== b.from_y || a.to_y != b.to_y)
            return false;
        for (var ii = a.from_x; ii <= a.to_x; ii++) {
            var aa = a.arr[ii];
            var bb = b.arr[ii];
            for (var jj = a.from_y; jj <= a.to_y; jj++) {
                if (aa[jj] !== bb[jj])
                    return false;
            }
        }
    ...
    var sarray = (function () {
        function sarray(arr, from_x, from_y, to_x, to_y) {
            this.arr = arr;
            this.from_x = from_x;
            this.to_x = to_x;
            this.from_y = from_y;
    ...
    var sscwidget2ddata = (function () {
        function sscwidget2ddata() {
        }
        return sscwidget2ddata;
    })();
    EE.sscwidget2ddata = sscwidget2ddata;

    function sscwidget2d(f, id, num1, num2, num3, num4, string1, string2, string3, string4, n10_arr, n10_from_x, n10_from_y, n10_to_x, n10_to_y, n11_arr, n11_from_x, n11_from_y, n11_to_x, n11_to_y, n12_arr, n12_from_x, n12_from_y, n12_to_x, n12_to_y, s13_arr, s13_from_x, s13_from_y, s13_to_x, s13_to_y, s14_arr, s14_from_x, s14_from_y, s14_to_x, s14_to_y, s15_arr, s15_from_x, s15_from_y, s15_to_x, s15_to_y) {
		n10_arr = deepClone(crop(s13_arr,n10_from_x, n10_from_y, n10_to_x, n10_to_y));
		n10_to_x = n10_to_x - n10_from_x;
		n10_to_y = n10_to_y - n10_from_y; 
		n10_from_x = n10_from_y = 0;
		
		n11_arr = deepClone(crop(n11_arr,n11_from_x, n11_from_y, n11_to_x, n11_to_y));
		n11_to_x = n11_to_x - n11_from_x;
		n11_to_y = n11_to_y - n11_from_y; 
		n11_from_x = n11_from_y = 0;
		
		n12_arr = deepClone(crop(n12_arr,n12_from_x, n12_from_y, n12_to_x, n12_to_y));
		n12_to_x = n12_to_x - n12_from_x;
		n12_to_y = n12_to_y - n12_from_y; 
		n12_from_x = n12_from_y = 0;
		
		s13_arr = deepClone(crop(s13_arr,s13_from_x, s13_from_y, s13_to_x, s13_to_y));
		s13_to_x = s13_to_x - s13_from_x;
		s13_to_y = s13_to_y - s13_from_y; 
		s13_from_x = s13_from_y = 0;
		
		s14_arr = deepClone(crop(s14_arr,s14_from_x, s14_from_y, s14_to_x, s14_to_y));
		s14_to_x = s14_to_x - s14_from_x;
		s14_to_y = s14_to_y - s14_from_y; 
		s14_from_x = s14_from_y = 0;
		
		s15_arr = deepClone(crop(s15_arr,s15_from_x, s15_from_y, s15_to_x, s15_to_y));
		s15_to_x = s15_to_x - s15_from_x;
		s15_to_y = s15_to_y - s15_from_y; 
		s15_from_x = s15_from_y = 0;
		
        var eeGlobal = EE.eeGlobal;
        var eeGlobalRevision = EE.eeGlobalRevision;
        var old = eeGlobal[id];
        if (old === undefined) {
            var data = new sscwidget2ddata();
            data.f = f;
            data.id = id;
            data.n1 = num1;
            data.n2 = num2;
            ...
            data.s3 = string3;
            data.s4 = string4;
            data.na1 = new narray(n10_arr, n10_from_x, n10_from_y, n10_to_x, n10_to_y);
            data.na2 = new narray(n11_arr, n11_from_x, n11_from_y, n11_to_x, n11_to_y);
            data.na3 = new narray(n12_arr, n11_from_x, n12_from_y, n11_to_x, n12_to_y);
            data.sa1 = new sarray(s13_arr, s13_from_x, s13_from_y, s13_to_x, s13_to_y);
            data.sa2 = new sarray(s14_arr, s14_from_x, s14_from_y, s14_to_x, s14_to_y);
            data.sa3 = new sarray(s15_arr, s15_from_x, s15_from_y, s15_to_x, s15_to_y);
            data.rev = eeGlobalRevision;
            eeGlobal[id] = data;
        } else {
            if (old.n1 !== num1) {
                old.n1 = num1;
                old.rev = eeGlobalRevision;
            }
            ;
            if (old.n2 !== num2) {
                old.n2 = num2;
            ...
            ;
            if (!naequal(old.na1, new narray(n10_arr, n10_from_x, n10_from_y, n10_to_x, n10_to_y))) {
                old.na1.arr = n10_arr;
                old.rev = eeGlobalRevision;
            }
            ;
            if (!naequal(old.na2, new narray(n11_arr, n11_from_x, n11_from_y, n11_to_x, n11_to_y))) {
                old.na2.arr = n11_arr;
                old.rev = eeGlobalRevision;
            }
            ;
            if (!naequal(old.na3, new narray(n12_arr, n11_from_x, n12_from_y, n11_to_x, n12_to_y))) {
                old.na3.arr = n12_arr;
                old.rev = eeGlobalRevision;
            }
            ;
            if (!saequal(old.sa1, new sarray(s13_arr, s13_from_x, s13_from_y, s13_to_x, s13_to_y))) {
                old.sa1.arr = s13_arr;
                old.rev = eeGlobalRevision;
            }
            ;
            if (!saequal(old.sa2, new sarray(s14_arr, s14_from_x, s14_from_y, s14_to_x, s14_to_y))) {
                old.sa2.arr = s14_arr;
                old.rev = eeGlobalRevision;
            }
            ;
            if (!saequal(old.sa3, new sarray(s15_arr, s15_from_x, s15_from_y, s15_to_x, s15_to_y))) {
                old.sa3.arr = s15_arr;
                old.rev = eeGlobalRevision;
            }
            ;
    ...
    EE.sscwidget2d = sscwidget2d;
    ;

    function sscwidget2dtest(data) {
        /*alert('sscwidget2d: Data changed\n\n' + JSON.stringify(data));*/
    }
    EE.sscwidget2dtest = sscwidget2dtest;
})(EE || (EE = {}));
...
function deepClone(o) {
	   var out, v, key;
	   out = (o instanceof Array) ? [] : {};
	   for (key in o) {
		   v = o[key];
		   out[key] = (typeof v === "object") ? deepClone(v) : v;
	   }
	   return out;
	} 
	function crop(arr, from_x, from_y, to_x, to_y){
		var arr = arr.slice(from_x, to_x+1);
		for(var i = 0; i < arr.length; i++){	
			arr[i] = arr[i].slice(from_y, to_y+1);
		}
		return arr;
}
var EE;
(function (EE) {
    /* I am trying to define an interface without using interfaces, why? */
    EE.eeGlobal = {};

    /* increased before each calc-iteration
    // so everything after calc that has rev==eeGlobalRevision has been changed
    // a bit brittle: really assumes calc is not run twice before checking if changes!!!! */
    EE.eeGlobalRevision = 0;
	EE.eeRecalcNeeded = false;
    ...
    function UpdateWidgets() {
        for (var name in EE.eeGlobal) {
            if (EE.eeGlobal.hasOwnProperty(name)) {
                var widget = EE.eeGlobal[name];
                if (widget.rev == EE.eeGlobalRevision) {
                    try  {
                        ExecuteFunctionByName(widget.f, window, [widget]);
                    } catch (err) {
                    }
                }
            }
        }
		if(EE.eeRecalcNeeded){
			EE.eeRecalcNeeded = false;
			recalc_onclick('');
		}
    }
    EE.UpdateWidgets = UpdateWidgets;	
})(EE || (EE = {}));
var arrtmp106xA1A1=new Array(1);for(var ii=0;ii<1;ii++){arrtmp106xA1A1[ii]=new Array(1);for(var jj=0;jj<1;jj++){arrtmp106xA1A1[ii][jj]=""}};var arrtmp105xA1C1=new Array(1);for(var ii=0;ii<1;ii++){arrtmp105xA1C1[ii]=new Array(3);for(var jj=0;jj<3;jj++){arrtmp105xA1C1[ii][jj]=""}};var arrtmp104xA1A1=new Array(1);for(var ii=0;ii<1;ii++){arrtmp104xA1A1[ii]=new Array(1);for(var jj=0;jj<1;jj++){arrtmp104xA1A1[ii][jj]=""}};var arrtmp103xA1A1=new Array(1);for(var ii=0;ii<1;ii++){arrtmp103xA1A1[ii]=new Array(1);for(var jj=0;jj<1;jj++){arrtmp103xA1A1[ii][jj]=0}};var arrtmp102xA1A1=new Array(1);for(var ii=0;ii<1;ii++){arrtmp102xA1A1[ii]=new Array(1);for(var jj=0;jj<1;jj++){arrtmp102xA1A1[ii][jj]=0}};var arrtmp101xA1A1=new Array(1);for(var ii=0;ii<1;ii++){arrtmp101xA1A1[ii]=new Array(1);for(var jj=0;jj<1;jj++){arrtmp101xA1A1[ii][jj]=0}};var arr1xB5B5=new Array(1);for(var ii=0;ii<1;ii++){arr1xB5B5[ii]=new Array(1);for(var jj=0;jj<1;jj++){arr1xB5B5[ii][jj]=0}};var row3xB31B72=new Array(42);for(var jj=0;jj<42;jj++){row3xB31B72[jj]=""};var row3xC31C72=new Array(42);for(var jj=0;jj<42;jj++){row3xC31C72[jj]=""};var arr3xD31D31=new Array(1);for(var ii=0;ii<1;ii++){arr3xD31D31[ii]=new Array(1);for(var jj=0;jj<1;jj++){arr3xD31D31[ii][jj]=""}};var arr3xE31E31=new Array(1);for(var ii=0;ii<1;ii++){arr3xE31E31[ii]=new Array(1);for(var jj=0;jj<1;jj++){arr3xE31E31[ii][jj]=""}};
var arr3xF31F31=new Array(1);for(var ii=0;ii<1;ii++){arr3xF31F31[ii]=new Array(1);for(var jj=0;jj<1;jj++){arr3xF31F31[ii][jj]=""}};var arr3xC32C73=new Array(42);for(var ii=0;ii<42;ii++){arr3xC32C73[ii]=new Array(1);for(var jj=0;jj<1;jj++){arr3xC32C73[ii][jj]=""}};var arr3xD32D73=new Array(42);for(var ii=0;ii<42;ii++){arr3xD32D73[ii]=new Array(1);for(var jj=0;jj<1;jj++){arr3xD32D73[ii][jj]=0}};var arr3xE32E73=new Array(42);for(var ii=0;ii<42;ii++){arr3xE32E73[ii]=new Array(1);for(var jj=0;jj<1;jj++){arr3xE32E73[ii][jj]=0}};var arr3xF32F73=new Array(42);for(var ii=0;ii<42;ii++){arr3xF32F73[ii]=new Array(1);for(var jj=0;jj<1;jj++){arr3xF32F73[ii][jj]=0}};var eecm1=new Array();var eecm2=new Array(new Array(arr1xB5B5,0,0,0,0));function calc(data){var c3B30=data['XLEW_3_30_2'];var c3C10=data['XLEW_3_10_3'];var c3C9=data['XLEW_3_9_3'];var c3C8=data['XLEW_3_8_3'];var c3C7=data['XLEW_3_7_3'];var c3C5=data['XLEW_3_5_3'];var c3C4=data['XLEW_3_4_3'];var c3C3=data['XLEW_3_3_3'];var c3C2=data['XLEW_3_2_3'];var c3C1=data['XLEW_3_1_3'];arrtmp106xA1A1[0][0]=("0");arrtmp105xA1C1[0][0]=("matching");arrtmp105xA1C1[0][1]=("firstcolumn");arrtmp105xA1C1[0][2]=("firstmatchonly");arrtmp104xA1A1[0][0]=("0");arrtmp103xA1A1[0][0]=(0);arrtmp102xA1A1[0][0]=(0);arrtmp101xA1A1[0][0]=(0);var c1A13=(0);var c1C13=(0);
 var c1B62=(41);var c2C1=("N");var c2C5=(0);var c2C7=(0);var c2C8=(30);var c2C9=(1);var c3A6=(true);row3xB31B72[0]=("Age");row3xC31C72[0]=("Year");arr3xD31D31[0][0]=("Income/Yr");arr3xE31E31[0][0]=("Annuity Payment/Yr");arr3xF31F31[0][0]=("Annuity Fixed Inv");var c7A1=(ssccf1n(("showhide"),(""),("_css5c5f"),(0)));var c7B1=(ssccf1n(("showhide"),(""),("_css7dfa"),(0)));var c7C1=(ssccf1n(("showhide"),(""),("_cssc932"),(0)));var c7D1=(ssccf1n(("showhide"),(""),("_cssb33f"),(0)));var c7E1=(ssccf1n(("showhide"),(""),("_css5839"),(0)));var c7F1=(ssccf1n(("showhide"),(""),("_css99a6"),(0)));var c7G1=(ssccf1n(("showhide"),(""),("_csse0ab"),(0)));var c7H1=(ssccf1n(("showhide"),(""),("_cssa107"),(0)));var c7I1=(ssccf1n(("showhide"),(""),("_css2d34"),(0)));var c7J1=(ssccf1n(("showhide"),(""),("_cssdef6"),(0)));var c7K1=(ssccf1n(("showhide"),(""),("_cssad9e"),(0)));var c7L1=(ssccf1n(("showhide"),(""),("_css583d"),(0)));var c7M1=(ssccf1n(("showhide"),(""),("_css3632"),(0)));var c7N1=(ssccf1n(("showhide"),(""),("_csscc8b"),(0)));var c7O1=(ssccf1n(("showhide"),(""),("_cssa227"),(0)));var c7P1=(ssccf1n(("showhide"),(""),("_css7d92"),(0)));var c7Q1=(ssccf1n(("showhide"),(""),("_cssfb0a"),(0)));var c7R1=(ssccf1n(("showhide"),(""),("_css8287"),(0)));var c7S1=(ssccf1n(("showhide"),(""),("_css3ce2"),(0)));
 var c7T1=(ssccf1n(("showhide"),(""),("_cssbae4"),(0)));var c7U1=(ssccf1n(("showhide"),(""),("_css802f"),(0)));var c7V1=(ssccf1n(("showhide"),(""),("_css77b4"),(0)));var c7W1=(ssccf1n(("showhide"),(""),("_cssff5b"),(0)));var c7X1=(ssccf1n(("showhide"),(""),("_cssa532"),(0)));var c7Y1=(ssccf1n(("showhide"),(""),("_css56cc"),(0)));var c7Z1=(ssccf1n(("showhide"),(""),("_css4bc9"),(0)));var c7AA1=(ssccf1n(("showhide"),(""),("_css1298"),(0)));var c7AB1=(ssccf1n(("showhide"),(""),("_cssd788"),(0)));var c7AC1=(ssccf1n(("showhide"),(""),("_css1581"),(0)));var c7AF1=(ssccf1n(("showhide"),(""),("_css68cc"),(0)));var c7AG1=(ssccf1n(("showhide"),(""),("_cssbdca"),(0)));var c1B4=(c2C5);var c1B6=(c2C7);var c1B7=(c2C8);var c1B8=(c2C9);var c2A1=(((str_eq((c2C1),("Y")))?(true):(false)));var c2C3=(c3C1);var c2C4=(c3C2);var c2C6=(c3C3);var c3D4=(((var_eq((c3C4),("")))?(0):(((((v2n(c3C4))-(c2C3)))+(c2C4)))));var c3D5=(((var_eq((c3C5),("")))?(0):(((((v2n(c3C5))-(c2C3)))+(c2C4)))));var c3A8=(((c3C8)/(100)));var c7AD1=(ssccf1n(("showhide"),(""),("_csscab4"),(v2n(c3B30))));var c7AH1=(ssccf1n(("showhide"),(""),("_css8c97"),(((c3A6)?1:0))));var c7AI1=(EE.sscwidget2d(("dynamicDropdown"),(""),(0),(0),(0),(0),(""),(""),(""),(""),arrtmp101xA1A1,0,0,0,0,arrtmp102xA1A1,0,0,0,0,arrtmp103xA1A1,0,0,0,0,arrtmp104xA1A1,0,0,0,0,arrtmp105xA1C1,0,0,0,2,arrtmp106xA1A1,0,0,0,0));
 var c8C1=(sscgetter(arr3xE31E31,0,0,0,0,("Annuity!$E$31"),("Annuity!$E$31")));var c8E1=(sscgetter(arr3xF31F31,0,0,0,0,("Annuity!$F$31"),("Annuity!$F$31")));var c8F1=(sscgetter(arr3xD31D31,0,0,0,0,("Annuity!$D$31"),("Annuity!$D$31")));var c1B2=(c2C3);var c1B3=(c2C4);arr1xB5B5[0][0]=(c2C6);var tmp253=(((((c1B6)-(c1B4)))+(v2n(c1B3))));var sumcnt254_sum=Math.max(Number.NEGATIVE_INFINITY,tmp253);var sumcnt254_cnt=1;var c1B60=(((max(1,sumcnt254_sum,sumcnt254_cnt,eecm2))+(1)));var c1B63=(c1B7);var c1B64=(c1B8);var c1B65=(((c1B62)-(c1B63)));var c3C6=(((pv((c3A8),(((c3C3)-(c3C2))),(((((c3C9)*(-1)))*(12))),(0),(0)))*(Math.pow((((1)-(c3A8))),(((v2n(c3C4))-(v2n(c3C10))))))));var c3C11=(((iserror((pmt((c3A8),(((v2n(c3C4))-(v2n(c3C10)))),(c3C6),(0),(0)))))?(0):(pmt((c3A8),(((v2n(c3C4))-(v2n(c3C10)))),(c3C6),(0),(0)))));var c7AE1=(ssccf1n(("showhide"),(""),("_css5a3c"),(((c2A1)?1:0))));var c1B59=(((eeisnumber((c1B3)))?(c1B3):("")));var c1B61=(((c1B60)-(v2n(c1B59))));var c1B66=(((((c1B61)-(((c1B63)*(c1B64)))))/(c1B65)));var tmp255=(6);var tmp256=(roundup((c1B66),(0)));var sumcnt257_sum=Math.min(Math.min(Number.POSITIVE_INFINITY,tmp256),tmp255);var sumcnt257_cnt=2;var c1B67=(min(0,sumcnt257_sum,sumcnt257_cnt,eecm1));var c1B69=(((c1B67)-(c1B66)));var c1B70=(((c1B69)*(c1B65)));var c1B71=(((((((c1B67)-(1)))==(0)))?(0):(roundup((((c1B70)/(((c1B67)-(1))))),(0)))));
 var c1B72=(c1B71);var c1C63=(((c1B63)+(c1B72)));var tmp1=(((1)<(c1C63)));var tmp2=(((1)>(c1B62)));var sumcnt3_sum=((false||tmp2)||tmp1);var sumcnt3_cnt=2;var c1A14=(v2n(((((1)==(1)))?(c1B3):(((((((c1A13)+(c1B67)))>(c1B60)))?(((c1A13)+(1))):((orgeneral(0,sumcnt3_sum,sumcnt3_cnt,eecm1))?(((c1A13)+(c1B64))):(((c1A13)+(c1B67)))))))));var tmp4=(((1)<(c1C63)));var tmp5=(((1)>(c1B62)));var sumcnt6_sum=((false||tmp5)||tmp4);var sumcnt6_cnt=2;var c1C14=(((((1)==(1)))?(c1B2):(((((((c1A13)+(c1B67)))>(c1B60)))?(((c1C13)+(1))):((orgeneral(0,sumcnt6_sum,sumcnt6_cnt,eecm1))?(((c1C13)+(c1B64))):(((c1C13)+(c1B67))))))));var tmp7=(((2)<(c1C63)));var tmp8=(((2)>(c1B62)));var sumcnt9_sum=((false||tmp8)||tmp7);var sumcnt9_cnt=2;var c1A15=(v2n(((((2)==(1)))?(c1B3):(((((((c1A14)+(c1B67)))>(c1B60)))?(((c1A14)+(1))):((orgeneral(0,sumcnt9_sum,sumcnt9_cnt,eecm1))?(((c1A14)+(c1B64))):(((c1A14)+(c1B67)))))))));var tmp10=(((2)<(c1C63)));var tmp11=(((2)>(c1B62)));var sumcnt12_sum=((false||tmp11)||tmp10);var sumcnt12_cnt=2;var c1C15=(((((2)==(1)))?(c1B2):(((((((c1A14)+(c1B67)))>(c1B60)))?(((c1C14)+(1))):((orgeneral(0,sumcnt12_sum,sumcnt12_cnt,eecm1))?(((c1C14)+(c1B64))):(((c1C14)+(c1B67))))))));var tmp13=(((3)<(c1C63)));var tmp14=(((3)>(c1B62)));var sumcnt15_sum=((false||tmp14)||tmp13);var sumcnt15_cnt=2;var c1A16=(v2n(((((3)==(1)))?(c1B3):(((((((c1A15)+(c1B67)))>(c1B60)))?(((c1A15)+(1))):((orgeneral(0,sumcnt15_sum,sumcnt15_cnt,eecm1))?(((c1A15)+(c1B64))):(((c1A15)+(c1B67)))))))));
 var tmp16=(((3)<(c1C63)));var tmp17=(((3)>(c1B62)));var sumcnt18_sum=((false||tmp17)||tmp16);var sumcnt18_cnt=2;var c1C16=(((((3)==(1)))?(c1B2):(((((((c1A15)+(c1B67)))>(c1B60)))?(((c1C15)+(1))):((orgeneral(0,sumcnt18_sum,sumcnt18_cnt,eecm1))?(((c1C15)+(c1B64))):(((c1C15)+(c1B67))))))));var tmp19=(((4)<(c1C63)));var tmp20=(((4)>(c1B62)));var sumcnt21_sum=((false||tmp20)||tmp19);var sumcnt21_cnt=2;var c1A17=(v2n(((((4)==(1)))?(c1B3):(((((((c1A16)+(c1B67)))>(c1B60)))?(((c1A16)+(1))):((orgeneral(0,sumcnt21_sum,sumcnt21_cnt,eecm1))?(((c1A16)+(c1B64))):(((c1A16)+(c1B67)))))))));var tmp22=(((4)<(c1C63)));var tmp23=(((4)>(c1B62)));var sumcnt24_sum=((false||tmp23)||tmp22);var sumcnt24_cnt=2;var c1C17=(((((4)==(1)))?(c1B2):(((((((c1A16)+(c1B67)))>(c1B60)))?(((c1C16)+(1))):((orgeneral(0,sumcnt24_sum,sumcnt24_cnt,eecm1))?(((c1C16)+(c1B64))):(((c1C16)+(c1B67))))))));var tmp25=(((5)<(c1C63)));var tmp26=(((5)>(c1B62)));var sumcnt27_sum=((false||tmp26)||tmp25);var sumcnt27_cnt=2;var c1A18=(v2n(((((5)==(1)))?(c1B3):(((((((c1A17)+(c1B67)))>(c1B60)))?(((c1A17)+(1))):((orgeneral(0,sumcnt27_sum,sumcnt27_cnt,eecm1))?(((c1A17)+(c1B64))):(((c1A17)+(c1B67)))))))));var tmp28=(((5)<(c1C63)));var tmp29=(((5)>(c1B62)));var sumcnt30_sum=((false||tmp29)||tmp28);var sumcnt30_cnt=2;var c1C18=(((((5)==(1)))?(c1B2):(((((((c1A17)+(c1B67)))>(c1B60)))?(((c1C17)+(1))):((orgeneral(0,sumcnt30_sum,sumcnt30_cnt,eecm1))?(((c1C17)+(c1B64))):(((c1C17)+(c1B67))))))));
 var tmp31=(((6)<(c1C63)));var tmp32=(((6)>(c1B62)));var sumcnt33_sum=((false||tmp32)||tmp31);var sumcnt33_cnt=2;var c1A19=(v2n(((((6)==(1)))?(c1B3):(((((((c1A18)+(c1B67)))>(c1B60)))?(((c1A18)+(1))):((orgeneral(0,sumcnt33_sum,sumcnt33_cnt,eecm1))?(((c1A18)+(c1B64))):(((c1A18)+(c1B67)))))))));var tmp34=(((6)<(c1C63)));var tmp35=(((6)>(c1B62)));var sumcnt36_sum=((false||tmp35)||tmp34);var sumcnt36_cnt=2;var c1C19=(((((6)==(1)))?(c1B2):(((((((c1A18)+(c1B67)))>(c1B60)))?(((c1C18)+(1))):((orgeneral(0,sumcnt36_sum,sumcnt36_cnt,eecm1))?(((c1C18)+(c1B64))):(((c1C18)+(c1B67))))))));var tmp37=(((7)<(c1C63)));var tmp38=(((7)>(c1B62)));var sumcnt39_sum=((false||tmp38)||tmp37);var sumcnt39_cnt=2;var c1A20=(v2n(((((7)==(1)))?(c1B3):(((((((c1A19)+(c1B67)))>(c1B60)))?(((c1A19)+(1))):((orgeneral(0,sumcnt39_sum,sumcnt39_cnt,eecm1))?(((c1A19)+(c1B64))):(((c1A19)+(c1B67)))))))));var tmp40=(((7)<(c1C63)));var tmp41=(((7)>(c1B62)));var sumcnt42_sum=((false||tmp41)||tmp40);var sumcnt42_cnt=2;var c1C20=(((((7)==(1)))?(c1B2):(((((((c1A19)+(c1B67)))>(c1B60)))?(((c1C19)+(1))):((orgeneral(0,sumcnt42_sum,sumcnt42_cnt,eecm1))?(((c1C19)+(c1B64))):(((c1C19)+(c1B67))))))));var tmp43=(((8)<(c1C63)));var tmp44=(((8)>(c1B62)));var sumcnt45_sum=((false||tmp44)||tmp43);var sumcnt45_cnt=2;var c1A21=(v2n(((((8)==(1)))?(c1B3):(((((((c1A20)+(c1B67)))>(c1B60)))?(((c1A20)+(1))):((orgeneral(0,sumcnt45_sum,sumcnt45_cnt,eecm1))?(((c1A20)+(c1B64))):(((c1A20)+(c1B67)))))))));
 var tmp46=(((8)<(c1C63)));var tmp47=(((8)>(c1B62)));var sumcnt48_sum=((false||tmp47)||tmp46);var sumcnt48_cnt=2;var c1C21=(((((8)==(1)))?(c1B2):(((((((c1A20)+(c1B67)))>(c1B60)))?(((c1C20)+(1))):((orgeneral(0,sumcnt48_sum,sumcnt48_cnt,eecm1))?(((c1C20)+(c1B64))):(((c1C20)+(c1B67))))))));var tmp49=(((9)<(c1C63)));var tmp50=(((9)>(c1B62)));var sumcnt51_sum=((false||tmp50)||tmp49);var sumcnt51_cnt=2;var c1A22=(v2n(((((9)==(1)))?(c1B3):(((((((c1A21)+(c1B67)))>(c1B60)))?(((c1A21)+(1))):((orgeneral(0,sumcnt51_sum,sumcnt51_cnt,eecm1))?(((c1A21)+(c1B64))):(((c1A21)+(c1B67)))))))));var tmp52=(((9)<(c1C63)));var tmp53=(((9)>(c1B62)));var sumcnt54_sum=((false||tmp53)||tmp52);var sumcnt54_cnt=2;var c1C22=(((((9)==(1)))?(c1B2):(((((((c1A21)+(c1B67)))>(c1B60)))?(((c1C21)+(1))):((orgeneral(0,sumcnt54_sum,sumcnt54_cnt,eecm1))?(((c1C21)+(c1B64))):(((c1C21)+(c1B67))))))));var tmp55=(((10)<(c1C63)));var tmp56=(((10)>(c1B62)));var sumcnt57_sum=((false||tmp56)||tmp55);var sumcnt57_cnt=2;var c1A23=(v2n(((((10)==(1)))?(c1B3):(((((((c1A22)+(c1B67)))>(c1B60)))?(((c1A22)+(1))):((orgeneral(0,sumcnt57_sum,sumcnt57_cnt,eecm1))?(((c1A22)+(c1B64))):(((c1A22)+(c1B67)))))))));var tmp58=(((10)<(c1C63)));var tmp59=(((10)>(c1B62)));var sumcnt60_sum=((false||tmp59)||tmp58);var sumcnt60_cnt=2;var c1C23=(((((10)==(1)))?(c1B2):(((((((c1A22)+(c1B67)))>(c1B60)))?(((c1C22)+(1))):((orgeneral(0,sumcnt60_sum,sumcnt60_cnt,eecm1))?(((c1C22)+(c1B64))):(((c1C22)+(c1B67))))))));
 var tmp61=(((11)<(c1C63)));var tmp62=(((11)>(c1B62)));var sumcnt63_sum=((false||tmp62)||tmp61);var sumcnt63_cnt=2;var c1A24=(v2n(((((11)==(1)))?(c1B3):(((((((c1A23)+(c1B67)))>(c1B60)))?(((c1A23)+(1))):((orgeneral(0,sumcnt63_sum,sumcnt63_cnt,eecm1))?(((c1A23)+(c1B64))):(((c1A23)+(c1B67)))))))));var tmp64=(((11)<(c1C63)));var tmp65=(((11)>(c1B62)));var sumcnt66_sum=((false||tmp65)||tmp64);var sumcnt66_cnt=2;var c1C24=(((((11)==(1)))?(c1B2):(((((((c1A23)+(c1B67)))>(c1B60)))?(((c1C23)+(1))):((orgeneral(0,sumcnt66_sum,sumcnt66_cnt,eecm1))?(((c1C23)+(c1B64))):(((c1C23)+(c1B67))))))));var tmp67=(((12)<(c1C63)));var tmp68=(((12)>(c1B62)));var sumcnt69_sum=((false||tmp68)||tmp67);var sumcnt69_cnt=2;var c1A25=(v2n(((((12)==(1)))?(c1B3):(((((((c1A24)+(c1B67)))>(c1B60)))?(((c1A24)+(1))):((orgeneral(0,sumcnt69_sum,sumcnt69_cnt,eecm1))?(((c1A24)+(c1B64))):(((c1A24)+(c1B67)))))))));var tmp70=(((12)<(c1C63)));var tmp71=(((12)>(c1B62)));var sumcnt72_sum=((false||tmp71)||tmp70);var sumcnt72_cnt=2;var c1C25=(((((12)==(1)))?(c1B2):(((((((c1A24)+(c1B67)))>(c1B60)))?(((c1C24)+(1))):((orgeneral(0,sumcnt72_sum,sumcnt72_cnt,eecm1))?(((c1C24)+(c1B64))):(((c1C24)+(c1B67))))))));var tmp73=(((13)<(c1C63)));var tmp74=(((13)>(c1B62)));var sumcnt75_sum=((false||tmp74)||tmp73);var sumcnt75_cnt=2;var c1A26=(v2n(((((13)==(1)))?(c1B3):(((((((c1A25)+(c1B67)))>(c1B60)))?(((c1A25)+(1))):((orgeneral(0,sumcnt75_sum,sumcnt75_cnt,eecm1))?(((c1A25)+(c1B64))):(((c1A25)+(c1B67)))))))));
 var tmp76=(((13)<(c1C63)));var tmp77=(((13)>(c1B62)));var sumcnt78_sum=((false||tmp77)||tmp76);var sumcnt78_cnt=2;var c1C26=(((((13)==(1)))?(c1B2):(((((((c1A25)+(c1B67)))>(c1B60)))?(((c1C25)+(1))):((orgeneral(0,sumcnt78_sum,sumcnt78_cnt,eecm1))?(((c1C25)+(c1B64))):(((c1C25)+(c1B67))))))));var tmp79=(((14)<(c1C63)));var tmp80=(((14)>(c1B62)));var sumcnt81_sum=((false||tmp80)||tmp79);var sumcnt81_cnt=2;var c1A27=(v2n(((((14)==(1)))?(c1B3):(((((((c1A26)+(c1B67)))>(c1B60)))?(((c1A26)+(1))):((orgeneral(0,sumcnt81_sum,sumcnt81_cnt,eecm1))?(((c1A26)+(c1B64))):(((c1A26)+(c1B67)))))))));var tmp82=(((14)<(c1C63)));var tmp83=(((14)>(c1B62)));var sumcnt84_sum=((false||tmp83)||tmp82);var sumcnt84_cnt=2;var c1C27=(((((14)==(1)))?(c1B2):(((((((c1A26)+(c1B67)))>(c1B60)))?(((c1C26)+(1))):((orgeneral(0,sumcnt84_sum,sumcnt84_cnt,eecm1))?(((c1C26)+(c1B64))):(((c1C26)+(c1B67))))))));var tmp85=(((15)<(c1C63)));var tmp86=(((15)>(c1B62)));var sumcnt87_sum=((false||tmp86)||tmp85);var sumcnt87_cnt=2;var c1A28=(v2n(((((15)==(1)))?(c1B3):(((((((c1A27)+(c1B67)))>(c1B60)))?(((c1A27)+(1))):((orgeneral(0,sumcnt87_sum,sumcnt87_cnt,eecm1))?(((c1A27)+(c1B64))):(((c1A27)+(c1B67)))))))));var tmp88=(((15)<(c1C63)));var tmp89=(((15)>(c1B62)));var sumcnt90_sum=((false||tmp89)||tmp88);var sumcnt90_cnt=2;var c1C28=(((((15)==(1)))?(c1B2):(((((((c1A27)+(c1B67)))>(c1B60)))?(((c1C27)+(1))):((orgeneral(0,sumcnt90_sum,sumcnt90_cnt,eecm1))?(((c1C27)+(c1B64))):(((c1C27)+(c1B67))))))));
 var tmp91=(((16)<(c1C63)));var tmp92=(((16)>(c1B62)));var sumcnt93_sum=((false||tmp92)||tmp91);var sumcnt93_cnt=2;var c1A29=(v2n(((((16)==(1)))?(c1B3):(((((((c1A28)+(c1B67)))>(c1B60)))?(((c1A28)+(1))):((orgeneral(0,sumcnt93_sum,sumcnt93_cnt,eecm1))?(((c1A28)+(c1B64))):(((c1A28)+(c1B67)))))))));var tmp94=(((16)<(c1C63)));var tmp95=(((16)>(c1B62)));var sumcnt96_sum=((false||tmp95)||tmp94);var sumcnt96_cnt=2;var c1C29=(((((16)==(1)))?(c1B2):(((((((c1A28)+(c1B67)))>(c1B60)))?(((c1C28)+(1))):((orgeneral(0,sumcnt96_sum,sumcnt96_cnt,eecm1))?(((c1C28)+(c1B64))):(((c1C28)+(c1B67))))))));var tmp97=(((17)<(c1C63)));var tmp98=(((17)>(c1B62)));var sumcnt99_sum=((false||tmp98)||tmp97);var sumcnt99_cnt=2;var c1A30=(v2n(((((17)==(1)))?(c1B3):(((((((c1A29)+(c1B67)))>(c1B60)))?(((c1A29)+(1))):((orgeneral(0,sumcnt99_sum,sumcnt99_cnt,eecm1))?(((c1A29)+(c1B64))):(((c1A29)+(c1B67)))))))));var tmp100=(((17)<(c1C63)));var tmp101=(((17)>(c1B62)));var sumcnt102_sum=((false||tmp101)||tmp100);var sumcnt102_cnt=2;var c1C30=(((((17)==(1)))?(c1B2):(((((((c1A29)+(c1B67)))>(c1B60)))?(((c1C29)+(1))):((orgeneral(0,sumcnt102_sum,sumcnt102_cnt,eecm1))?(((c1C29)+(c1B64))):(((c1C29)+(c1B67))))))));var tmp103=(((18)<(c1C63)));var tmp104=(((18)>(c1B62)));var sumcnt105_sum=((false||tmp104)||tmp103);var sumcnt105_cnt=2;var c1A31=(v2n(((((18)==(1)))?(c1B3):(((((((c1A30)+(c1B67)))>(c1B60)))?(((c1A30)+(1))):((orgeneral(0,sumcnt105_sum,sumcnt105_cnt,eecm1))?(((c1A30)+(c1B64))):(((c1A30)+(c1B67)))))))));
 var tmp106=(((18)<(c1C63)));var tmp107=(((18)>(c1B62)));var sumcnt108_sum=((false||tmp107)||tmp106);var sumcnt108_cnt=2;var c1C31=(((((18)==(1)))?(c1B2):(((((((c1A30)+(c1B67)))>(c1B60)))?(((c1C30)+(1))):((orgeneral(0,sumcnt108_sum,sumcnt108_cnt,eecm1))?(((c1C30)+(c1B64))):(((c1C30)+(c1B67))))))));var tmp109=(((19)<(c1C63)));var tmp110=(((19)>(c1B62)));var sumcnt111_sum=((false||tmp110)||tmp109);var sumcnt111_cnt=2;var c1A32=(v2n(((((19)==(1)))?(c1B3):(((((((c1A31)+(c1B67)))>(c1B60)))?(((c1A31)+(1))):((orgeneral(0,sumcnt111_sum,sumcnt111_cnt,eecm1))?(((c1A31)+(c1B64))):(((c1A31)+(c1B67)))))))));var tmp112=(((19)<(c1C63)));var tmp113=(((19)>(c1B62)));var sumcnt114_sum=((false||tmp113)||tmp112);var sumcnt114_cnt=2;var c1C32=(((((19)==(1)))?(c1B2):(((((((c1A31)+(c1B67)))>(c1B60)))?(((c1C31)+(1))):((orgeneral(0,sumcnt114_sum,sumcnt114_cnt,eecm1))?(((c1C31)+(c1B64))):(((c1C31)+(c1B67))))))));var tmp115=(((20)<(c1C63)));var tmp116=(((20)>(c1B62)));var sumcnt117_sum=((false||tmp116)||tmp115);var sumcnt117_cnt=2;var c1A33=(v2n(((((20)==(1)))?(c1B3):(((((((c1A32)+(c1B67)))>(c1B60)))?(((c1A32)+(1))):((orgeneral(0,sumcnt117_sum,sumcnt117_cnt,eecm1))?(((c1A32)+(c1B64))):(((c1A32)+(c1B67)))))))));var tmp118=(((20)<(c1C63)));var tmp119=(((20)>(c1B62)));var sumcnt120_sum=((false||tmp119)||tmp118);var sumcnt120_cnt=2;var c1C33=(((((20)==(1)))?(c1B2):(((((((c1A32)+(c1B67)))>(c1B60)))?(((c1C32)+(1))):((orgeneral(0,sumcnt120_sum,sumcnt120_cnt,eecm1))?(((c1C32)+(c1B64))):(((c1C32)+(c1B67))))))));
 var tmp121=(((21)<(c1C63)));var tmp122=(((21)>(c1B62)));var sumcnt123_sum=((false||tmp122)||tmp121);var sumcnt123_cnt=2;var c1A34=(v2n(((((21)==(1)))?(c1B3):(((((((c1A33)+(c1B67)))>(c1B60)))?(((c1A33)+(1))):((orgeneral(0,sumcnt123_sum,sumcnt123_cnt,eecm1))?(((c1A33)+(c1B64))):(((c1A33)+(c1B67)))))))));var tmp124=(((21)<(c1C63)));var tmp125=(((21)>(c1B62)));var sumcnt126_sum=((false||tmp125)||tmp124);var sumcnt126_cnt=2;var c1C34=(((((21)==(1)))?(c1B2):(((((((c1A33)+(c1B67)))>(c1B60)))?(((c1C33)+(1))):((orgeneral(0,sumcnt126_sum,sumcnt126_cnt,eecm1))?(((c1C33)+(c1B64))):(((c1C33)+(c1B67))))))));var tmp127=(((22)<(c1C63)));var tmp128=(((22)>(c1B62)));var sumcnt129_sum=((false||tmp128)||tmp127);var sumcnt129_cnt=2;var c1A35=(v2n(((((22)==(1)))?(c1B3):(((((((c1A34)+(c1B67)))>(c1B60)))?(((c1A34)+(1))):((orgeneral(0,sumcnt129_sum,sumcnt129_cnt,eecm1))?(((c1A34)+(c1B64))):(((c1A34)+(c1B67)))))))));var tmp130=(((22)<(c1C63)));var tmp131=(((22)>(c1B62)));var sumcnt132_sum=((false||tmp131)||tmp130);var sumcnt132_cnt=2;var c1C35=(((((22)==(1)))?(c1B2):(((((((c1A34)+(c1B67)))>(c1B60)))?(((c1C34)+(1))):((orgeneral(0,sumcnt132_sum,sumcnt132_cnt,eecm1))?(((c1C34)+(c1B64))):(((c1C34)+(c1B67))))))));var tmp133=(((23)<(c1C63)));var tmp134=(((23)>(c1B62)));var sumcnt135_sum=((false||tmp134)||tmp133);var sumcnt135_cnt=2;var c1A36=(v2n(((((23)==(1)))?(c1B3):(((((((c1A35)+(c1B67)))>(c1B60)))?(((c1A35)+(1))):((orgeneral(0,sumcnt135_sum,sumcnt135_cnt,eecm1))?(((c1A35)+(c1B64))):(((c1A35)+(c1B67)))))))));
 var tmp136=(((23)<(c1C63)));var tmp137=(((23)>(c1B62)));var sumcnt138_sum=((false||tmp137)||tmp136);var sumcnt138_cnt=2;var c1C36=(((((23)==(1)))?(c1B2):(((((((c1A35)+(c1B67)))>(c1B60)))?(((c1C35)+(1))):((orgeneral(0,sumcnt138_sum,sumcnt138_cnt,eecm1))?(((c1C35)+(c1B64))):(((c1C35)+(c1B67))))))));var tmp139=(((24)<(c1C63)));var tmp140=(((24)>(c1B62)));var sumcnt141_sum=((false||tmp140)||tmp139);var sumcnt141_cnt=2;var c1A37=(v2n(((((24)==(1)))?(c1B3):(((((((c1A36)+(c1B67)))>(c1B60)))?(((c1A36)+(1))):((orgeneral(0,sumcnt141_sum,sumcnt141_cnt,eecm1))?(((c1A36)+(c1B64))):(((c1A36)+(c1B67)))))))));var tmp142=(((24)<(c1C63)));var tmp143=(((24)>(c1B62)));var sumcnt144_sum=((false||tmp143)||tmp142);var sumcnt144_cnt=2;var c1C37=(((((24)==(1)))?(c1B2):(((((((c1A36)+(c1B67)))>(c1B60)))?(((c1C36)+(1))):((orgeneral(0,sumcnt144_sum,sumcnt144_cnt,eecm1))?(((c1C36)+(c1B64))):(((c1C36)+(c1B67))))))));var tmp145=(((25)<(c1C63)));var tmp146=(((25)>(c1B62)));var sumcnt147_sum=((false||tmp146)||tmp145);var sumcnt147_cnt=2;var c1A38=(v2n(((((25)==(1)))?(c1B3):(((((((c1A37)+(c1B67)))>(c1B60)))?(((c1A37)+(1))):((orgeneral(0,sumcnt147_sum,sumcnt147_cnt,eecm1))?(((c1A37)+(c1B64))):(((c1A37)+(c1B67)))))))));var tmp148=(((25)<(c1C63)));var tmp149=(((25)>(c1B62)));var sumcnt150_sum=((false||tmp149)||tmp148);var sumcnt150_cnt=2;var c1C38=(((((25)==(1)))?(c1B2):(((((((c1A37)+(c1B67)))>(c1B60)))?(((c1C37)+(1))):((orgeneral(0,sumcnt150_sum,sumcnt150_cnt,eecm1))?(((c1C37)+(c1B64))):(((c1C37)+(c1B67))))))));
 var tmp151=(((26)<(c1C63)));var tmp152=(((26)>(c1B62)));var sumcnt153_sum=((false||tmp152)||tmp151);var sumcnt153_cnt=2;var c1A39=(v2n(((((26)==(1)))?(c1B3):(((((((c1A38)+(c1B67)))>(c1B60)))?(((c1A38)+(1))):((orgeneral(0,sumcnt153_sum,sumcnt153_cnt,eecm1))?(((c1A38)+(c1B64))):(((c1A38)+(c1B67)))))))));var tmp154=(((26)<(c1C63)));var tmp155=(((26)>(c1B62)));var sumcnt156_sum=((false||tmp155)||tmp154);var sumcnt156_cnt=2;var c1C39=(((((26)==(1)))?(c1B2):(((((((c1A38)+(c1B67)))>(c1B60)))?(((c1C38)+(1))):((orgeneral(0,sumcnt156_sum,sumcnt156_cnt,eecm1))?(((c1C38)+(c1B64))):(((c1C38)+(c1B67))))))));var tmp157=(((27)<(c1C63)));var tmp158=(((27)>(c1B62)));var sumcnt159_sum=((false||tmp158)||tmp157);var sumcnt159_cnt=2;var c1A40=(v2n(((((27)==(1)))?(c1B3):(((((((c1A39)+(c1B67)))>(c1B60)))?(((c1A39)+(1))):((orgeneral(0,sumcnt159_sum,sumcnt159_cnt,eecm1))?(((c1A39)+(c1B64))):(((c1A39)+(c1B67)))))))));var tmp160=(((27)<(c1C63)));var tmp161=(((27)>(c1B62)));var sumcnt162_sum=((false||tmp161)||tmp160);var sumcnt162_cnt=2;var c1C40=(((((27)==(1)))?(c1B2):(((((((c1A39)+(c1B67)))>(c1B60)))?(((c1C39)+(1))):((orgeneral(0,sumcnt162_sum,sumcnt162_cnt,eecm1))?(((c1C39)+(c1B64))):(((c1C39)+(c1B67))))))));var tmp163=(((28)<(c1C63)));var tmp164=(((28)>(c1B62)));var sumcnt165_sum=((false||tmp164)||tmp163);var sumcnt165_cnt=2;var c1A41=(v2n(((((28)==(1)))?(c1B3):(((((((c1A40)+(c1B67)))>(c1B60)))?(((c1A40)+(1))):((orgeneral(0,sumcnt165_sum,sumcnt165_cnt,eecm1))?(((c1A40)+(c1B64))):(((c1A40)+(c1B67)))))))));
 var tmp166=(((28)<(c1C63)));var tmp167=(((28)>(c1B62)));var sumcnt168_sum=((false||tmp167)||tmp166);var sumcnt168_cnt=2;var c1C41=(((((28)==(1)))?(c1B2):(((((((c1A40)+(c1B67)))>(c1B60)))?(((c1C40)+(1))):((orgeneral(0,sumcnt168_sum,sumcnt168_cnt,eecm1))?(((c1C40)+(c1B64))):(((c1C40)+(c1B67))))))));var tmp169=(((29)<(c1C63)));var tmp170=(((29)>(c1B62)));var sumcnt171_sum=((false||tmp170)||tmp169);var sumcnt171_cnt=2;var c1A42=(v2n(((((29)==(1)))?(c1B3):(((((((c1A41)+(c1B67)))>(c1B60)))?(((c1A41)+(1))):((orgeneral(0,sumcnt171_sum,sumcnt171_cnt,eecm1))?(((c1A41)+(c1B64))):(((c1A41)+(c1B67)))))))));var tmp172=(((29)<(c1C63)));var tmp173=(((29)>(c1B62)));var sumcnt174_sum=((false||tmp173)||tmp172);var sumcnt174_cnt=2;var c1C42=(((((29)==(1)))?(c1B2):(((((((c1A41)+(c1B67)))>(c1B60)))?(((c1C41)+(1))):((orgeneral(0,sumcnt174_sum,sumcnt174_cnt,eecm1))?(((c1C41)+(c1B64))):(((c1C41)+(c1B67))))))));var tmp175=(((30)<(c1C63)));var tmp176=(((30)>(c1B62)));var sumcnt177_sum=((false||tmp176)||tmp175);var sumcnt177_cnt=2;var c1A43=(v2n(((((30)==(1)))?(c1B3):(((((((c1A42)+(c1B67)))>(c1B60)))?(((c1A42)+(1))):((orgeneral(0,sumcnt177_sum,sumcnt177_cnt,eecm1))?(((c1A42)+(c1B64))):(((c1A42)+(c1B67)))))))));var tmp178=(((30)<(c1C63)));var tmp179=(((30)>(c1B62)));var sumcnt180_sum=((false||tmp179)||tmp178);var sumcnt180_cnt=2;var c1C43=(((((30)==(1)))?(c1B2):(((((((c1A42)+(c1B67)))>(c1B60)))?(((c1C42)+(1))):((orgeneral(0,sumcnt180_sum,sumcnt180_cnt,eecm1))?(((c1C42)+(c1B64))):(((c1C42)+(c1B67))))))));
 var tmp181=(((31)<(c1C63)));var tmp182=(((31)>(c1B62)));var sumcnt183_sum=((false||tmp182)||tmp181);var sumcnt183_cnt=2;var c1A44=(v2n(((((31)==(1)))?(c1B3):(((((((c1A43)+(c1B67)))>(c1B60)))?(((c1A43)+(1))):((orgeneral(0,sumcnt183_sum,sumcnt183_cnt,eecm1))?(((c1A43)+(c1B64))):(((c1A43)+(c1B67)))))))));var tmp184=(((31)<(c1C63)));var tmp185=(((31)>(c1B62)));var sumcnt186_sum=((false||tmp185)||tmp184);var sumcnt186_cnt=2;var c1C44=(((((31)==(1)))?(c1B2):(((((((c1A43)+(c1B67)))>(c1B60)))?(((c1C43)+(1))):((orgeneral(0,sumcnt186_sum,sumcnt186_cnt,eecm1))?(((c1C43)+(c1B64))):(((c1C43)+(c1B67))))))));var tmp187=(((32)<(c1C63)));var tmp188=(((32)>(c1B62)));var sumcnt189_sum=((false||tmp188)||tmp187);var sumcnt189_cnt=2;var c1A45=(v2n(((((32)==(1)))?(c1B3):(((((((c1A44)+(c1B67)))>(c1B60)))?(((c1A44)+(1))):((orgeneral(0,sumcnt189_sum,sumcnt189_cnt,eecm1))?(((c1A44)+(c1B64))):(((c1A44)+(c1B67)))))))));var tmp190=(((32)<(c1C63)));var tmp191=(((32)>(c1B62)));var sumcnt192_sum=((false||tmp191)||tmp190);var sumcnt192_cnt=2;var c1C45=(((((32)==(1)))?(c1B2):(((((((c1A44)+(c1B67)))>(c1B60)))?(((c1C44)+(1))):((orgeneral(0,sumcnt192_sum,sumcnt192_cnt,eecm1))?(((c1C44)+(c1B64))):(((c1C44)+(c1B67))))))));var tmp193=(((33)<(c1C63)));var tmp194=(((33)>(c1B62)));var sumcnt195_sum=((false||tmp194)||tmp193);var sumcnt195_cnt=2;var c1A46=(v2n(((((33)==(1)))?(c1B3):(((((((c1A45)+(c1B67)))>(c1B60)))?(((c1A45)+(1))):((orgeneral(0,sumcnt195_sum,sumcnt195_cnt,eecm1))?(((c1A45)+(c1B64))):(((c1A45)+(c1B67)))))))));
 var tmp196=(((33)<(c1C63)));var tmp197=(((33)>(c1B62)));var sumcnt198_sum=((false||tmp197)||tmp196);var sumcnt198_cnt=2;var c1C46=(((((33)==(1)))?(c1B2):(((((((c1A45)+(c1B67)))>(c1B60)))?(((c1C45)+(1))):((orgeneral(0,sumcnt198_sum,sumcnt198_cnt,eecm1))?(((c1C45)+(c1B64))):(((c1C45)+(c1B67))))))));var tmp199=(((34)<(c1C63)));var tmp200=(((34)>(c1B62)));var sumcnt201_sum=((false||tmp200)||tmp199);var sumcnt201_cnt=2;var c1A47=(v2n(((((34)==(1)))?(c1B3):(((((((c1A46)+(c1B67)))>(c1B60)))?(((c1A46)+(1))):((orgeneral(0,sumcnt201_sum,sumcnt201_cnt,eecm1))?(((c1A46)+(c1B64))):(((c1A46)+(c1B67)))))))));var tmp202=(((34)<(c1C63)));var tmp203=(((34)>(c1B62)));var sumcnt204_sum=((false||tmp203)||tmp202);var sumcnt204_cnt=2;var c1C47=(((((34)==(1)))?(c1B2):(((((((c1A46)+(c1B67)))>(c1B60)))?(((c1C46)+(1))):((orgeneral(0,sumcnt204_sum,sumcnt204_cnt,eecm1))?(((c1C46)+(c1B64))):(((c1C46)+(c1B67))))))));var tmp205=(((35)<(c1C63)));var tmp206=(((35)>(c1B62)));var sumcnt207_sum=((false||tmp206)||tmp205);var sumcnt207_cnt=2;var c1A48=(v2n(((((35)==(1)))?(c1B3):(((((((c1A47)+(c1B67)))>(c1B60)))?(((c1A47)+(1))):((orgeneral(0,sumcnt207_sum,sumcnt207_cnt,eecm1))?(((c1A47)+(c1B64))):(((c1A47)+(c1B67)))))))));var tmp208=(((35)<(c1C63)));var tmp209=(((35)>(c1B62)));var sumcnt210_sum=((false||tmp209)||tmp208);var sumcnt210_cnt=2;var c1C48=(((((35)==(1)))?(c1B2):(((((((c1A47)+(c1B67)))>(c1B60)))?(((c1C47)+(1))):((orgeneral(0,sumcnt210_sum,sumcnt210_cnt,eecm1))?(((c1C47)+(c1B64))):(((c1C47)+(c1B67))))))));
 var tmp211=(((36)<(c1C63)));var tmp212=(((36)>(c1B62)));var sumcnt213_sum=((false||tmp212)||tmp211);var sumcnt213_cnt=2;var c1A49=(v2n(((((36)==(1)))?(c1B3):(((((((c1A48)+(c1B67)))>(c1B60)))?(((c1A48)+(1))):((orgeneral(0,sumcnt213_sum,sumcnt213_cnt,eecm1))?(((c1A48)+(c1B64))):(((c1A48)+(c1B67)))))))));var tmp214=(((36)<(c1C63)));var tmp215=(((36)>(c1B62)));var sumcnt216_sum=((false||tmp215)||tmp214);var sumcnt216_cnt=2;var c1C49=(((((36)==(1)))?(c1B2):(((((((c1A48)+(c1B67)))>(c1B60)))?(((c1C48)+(1))):((orgeneral(0,sumcnt216_sum,sumcnt216_cnt,eecm1))?(((c1C48)+(c1B64))):(((c1C48)+(c1B67))))))));var tmp217=(((37)<(c1C63)));var tmp218=(((37)>(c1B62)));var sumcnt219_sum=((false||tmp218)||tmp217);var sumcnt219_cnt=2;var c1A50=(v2n(((((37)==(1)))?(c1B3):(((((((c1A49)+(c1B67)))>(c1B60)))?(((c1A49)+(1))):((orgeneral(0,sumcnt219_sum,sumcnt219_cnt,eecm1))?(((c1A49)+(c1B64))):(((c1A49)+(c1B67)))))))));var tmp220=(((37)<(c1C63)));var tmp221=(((37)>(c1B62)));var sumcnt222_sum=((false||tmp221)||tmp220);var sumcnt222_cnt=2;var c1C50=(((((37)==(1)))?(c1B2):(((((((c1A49)+(c1B67)))>(c1B60)))?(((c1C49)+(1))):((orgeneral(0,sumcnt222_sum,sumcnt222_cnt,eecm1))?(((c1C49)+(c1B64))):(((c1C49)+(c1B67))))))));var tmp223=(((38)<(c1C63)));var tmp224=(((38)>(c1B62)));var sumcnt225_sum=((false||tmp224)||tmp223);var sumcnt225_cnt=2;var c1A51=(v2n(((((38)==(1)))?(c1B3):(((((((c1A50)+(c1B67)))>(c1B60)))?(((c1A50)+(1))):((orgeneral(0,sumcnt225_sum,sumcnt225_cnt,eecm1))?(((c1A50)+(c1B64))):(((c1A50)+(c1B67)))))))));
 var tmp226=(((38)<(c1C63)));var tmp227=(((38)>(c1B62)));var sumcnt228_sum=((false||tmp227)||tmp226);var sumcnt228_cnt=2;var c1C51=(((((38)==(1)))?(c1B2):(((((((c1A50)+(c1B67)))>(c1B60)))?(((c1C50)+(1))):((orgeneral(0,sumcnt228_sum,sumcnt228_cnt,eecm1))?(((c1C50)+(c1B64))):(((c1C50)+(c1B67))))))));var tmp229=(((39)<(c1C63)));var tmp230=(((39)>(c1B62)));var sumcnt231_sum=((false||tmp230)||tmp229);var sumcnt231_cnt=2;var c1A52=(v2n(((((39)==(1)))?(c1B3):(((((((c1A51)+(c1B67)))>(c1B60)))?(((c1A51)+(1))):((orgeneral(0,sumcnt231_sum,sumcnt231_cnt,eecm1))?(((c1A51)+(c1B64))):(((c1A51)+(c1B67)))))))));var tmp232=(((39)<(c1C63)));var tmp233=(((39)>(c1B62)));var sumcnt234_sum=((false||tmp233)||tmp232);var sumcnt234_cnt=2;var c1C52=(((((39)==(1)))?(c1B2):(((((((c1A51)+(c1B67)))>(c1B60)))?(((c1C51)+(1))):((orgeneral(0,sumcnt234_sum,sumcnt234_cnt,eecm1))?(((c1C51)+(c1B64))):(((c1C51)+(c1B67))))))));var tmp235=(((40)<(c1C63)));var tmp236=(((40)>(c1B62)));var sumcnt237_sum=((false||tmp236)||tmp235);var sumcnt237_cnt=2;var c1A53=(v2n(((((40)==(1)))?(c1B3):(((((((c1A52)+(c1B67)))>(c1B60)))?(((c1A52)+(1))):((orgeneral(0,sumcnt237_sum,sumcnt237_cnt,eecm1))?(((c1A52)+(c1B64))):(((c1A52)+(c1B67)))))))));var tmp238=(((40)<(c1C63)));var tmp239=(((40)>(c1B62)));var sumcnt240_sum=((false||tmp239)||tmp238);var sumcnt240_cnt=2;var c1C53=(((((40)==(1)))?(c1B2):(((((((c1A52)+(c1B67)))>(c1B60)))?(((c1C52)+(1))):((orgeneral(0,sumcnt240_sum,sumcnt240_cnt,eecm1))?(((c1C52)+(c1B64))):(((c1C52)+(c1B67))))))));
 var tmp241=(((41)<(c1C63)));var tmp242=(((41)>(c1B62)));var sumcnt243_sum=((false||tmp242)||tmp241);var sumcnt243_cnt=2;var c1A54=(v2n(((((41)==(1)))?(c1B3):(((((((c1A53)+(c1B67)))>(c1B60)))?(((c1A53)+(1))):((orgeneral(0,sumcnt243_sum,sumcnt243_cnt,eecm1))?(((c1A53)+(c1B64))):(((c1A53)+(c1B67)))))))));var tmp244=(((41)<(c1C63)));var tmp245=(((41)>(c1B62)));var sumcnt246_sum=((false||tmp245)||tmp244);var sumcnt246_cnt=2;var c1C54=(((((41)==(1)))?(c1B2):(((((((c1A53)+(c1B67)))>(c1B60)))?(((c1C53)+(1))):((orgeneral(0,sumcnt246_sum,sumcnt246_cnt,eecm1))?(((c1C53)+(c1B64))):(((c1C53)+(c1B67))))))));var tmp247=(((42)<(c1C63)));var tmp248=(((42)>(c1B62)));var sumcnt249_sum=((false||tmp248)||tmp247);var sumcnt249_cnt=2;var c1A55=(v2n(((((42)==(1)))?(c1B3):(((((((c1A54)+(c1B67)))>(c1B60)))?(((c1A54)+(1))):((orgeneral(0,sumcnt249_sum,sumcnt249_cnt,eecm1))?(((c1A54)+(c1B64))):(((c1A54)+(c1B67)))))))));var tmp250=(((42)<(c1C63)));var tmp251=(((42)>(c1B62)));var sumcnt252_sum=((false||tmp251)||tmp250);var sumcnt252_cnt=2;var c1C55=(((((42)==(1)))?(c1B2):(((((((c1A54)+(c1B67)))>(c1B60)))?(((c1C54)+(1))):((orgeneral(0,sumcnt252_sum,sumcnt252_cnt,eecm1))?(((c1C54)+(c1B64))):(((c1C54)+(c1B67))))))));var c2B14=(c1A14);var c2D14=(c1C14);var c2B15=(c1A15);var c2D15=(c1C15);var c2B16=(c1A16);var c2D16=(c1C16);var c2B17=(c1A17);var c2D17=(c1C17);var c2B18=(c1A18);var c2D18=(c1C18);
 var c2B19=(c1A19);var c2D19=(c1C19);var c2B20=(c1A20);var c2D20=(c1C20);var c2B21=(c1A21);var c2D21=(c1C21);var c2B22=(c1A22);var c2D22=(c1C22);var c2B23=(c1A23);var c2D23=(c1C23);var c2B24=(c1A24);var c2D24=(c1C24);var c2B25=(c1A25);var c2D25=(c1C25);var c2B26=(c1A26);var c2D26=(c1C26);var c2B27=(c1A27);var c2D27=(c1C27);var c2B28=(c1A28);var c2D28=(c1C28);var c2B29=(c1A29);var c2D29=(c1C29);var c2B30=(c1A30);var c2D30=(c1C30);var c2B31=(c1A31);var c2D31=(c1C31);var c2B32=(c1A32);var c2D32=(c1C32);var c2B33=(c1A33);var c2D33=(c1C33);var c2B34=(c1A34);var c2D34=(c1C34);var c2B35=(c1A35);var c2D35=(c1C35);var c2B36=(c1A36);var c2D36=(c1C36);var c2B37=(c1A37);var c2D37=(c1C37);var c2B38=(c1A38);var c2D38=(c1C38);var c2B39=(c1A39);var c2D39=(c1C39);var c2B40=(c1A40);var c2D40=(c1C40);var c2B41=(c1A41);var c2D41=(c1C41);var c2B42=(c1A42);var c2D42=(c1C42);var c2B43=(c1A43);var c2D43=(c1C43);var c2B44=(c1A44);var c2D44=(c1C44);var c2B45=(c1A45);var c2D45=(c1C45);var c2B46=(c1A46);var c2D46=(c1C46);var c2B47=(c1A47);var c2D47=(c1C47);var c2B48=(c1A48);var c2D48=(c1C48);
 var c2B49=(c1A49);var c2D49=(c1C49);var c2B50=(c1A50);var c2D50=(c1C50);var c2B51=(c1A51);var c2D51=(c1C51);var c2B52=(c1A52);var c2D52=(c1C52);var c2B53=(c1A53);var c2D53=(c1C53);var c2B54=(c1A54);var c2D54=(c1C54);var c2B55=(c1A55);var c2D55=(c1C55);row3xB31B72[1]=(c2B14);arr3xC32C73[0][0]=(c2D14);row3xC31C72[1]=arr3xC32C73[0][0];var tmp261=(var_ge((arr3xC32C73[0][0]),(c3C10)));var tmp262=(var_ls((arr3xC32C73[0][0]),(c3C4)));var sumcnt263_sum=((true&&tmp262)&&tmp261);var sumcnt263_cnt=2;arr3xE32E73[0][0]=(((andgeneral(0,sumcnt263_sum,sumcnt263_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[0][0]=(((var_eq((arr3xC32C73[0][0]),(c3C10)))?(((c3C7)*(-1))):(0)));row3xB31B72[2]=(c2B15);arr3xC32C73[1][0]=(c2D15);row3xC31C72[2]=arr3xC32C73[1][0];var tmp267=(var_ge((arr3xC32C73[1][0]),(c3C10)));var tmp268=(var_ls((arr3xC32C73[1][0]),(c3C4)));var sumcnt269_sum=((true&&tmp268)&&tmp267);var sumcnt269_cnt=2;arr3xE32E73[1][0]=(((andgeneral(0,sumcnt269_sum,sumcnt269_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[1][0]=(((var_eq((arr3xC32C73[1][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[3]=(c2B16);arr3xC32C73[2][0]=(c2D16);row3xC31C72[3]=arr3xC32C73[2][0];var tmp273=(var_ge((arr3xC32C73[2][0]),(c3C10)));var tmp274=(var_ls((arr3xC32C73[2][0]),(c3C4)));var sumcnt275_sum=((true&&tmp274)&&tmp273);var sumcnt275_cnt=2;arr3xE32E73[2][0]=(((andgeneral(0,sumcnt275_sum,sumcnt275_cnt,eecm1))?(c3C11):(0)));
 arr3xF32F73[2][0]=(((var_eq((arr3xC32C73[2][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[4]=(c2B17);arr3xC32C73[3][0]=(c2D17);row3xC31C72[4]=arr3xC32C73[3][0];var tmp279=(var_ge((arr3xC32C73[3][0]),(c3C10)));var tmp280=(var_ls((arr3xC32C73[3][0]),(c3C4)));var sumcnt281_sum=((true&&tmp280)&&tmp279);var sumcnt281_cnt=2;arr3xE32E73[3][0]=(((andgeneral(0,sumcnt281_sum,sumcnt281_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[3][0]=(((var_eq((arr3xC32C73[3][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[5]=(c2B18);arr3xC32C73[4][0]=(c2D18);row3xC31C72[5]=arr3xC32C73[4][0];var tmp285=(var_ge((arr3xC32C73[4][0]),(c3C10)));var tmp286=(var_ls((arr3xC32C73[4][0]),(c3C4)));var sumcnt287_sum=((true&&tmp286)&&tmp285);var sumcnt287_cnt=2;arr3xE32E73[4][0]=(((andgeneral(0,sumcnt287_sum,sumcnt287_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[4][0]=(((var_eq((arr3xC32C73[4][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[6]=(c2B19);arr3xC32C73[5][0]=(c2D19);row3xC31C72[6]=arr3xC32C73[5][0];var tmp291=(var_ge((arr3xC32C73[5][0]),(c3C10)));var tmp292=(var_ls((arr3xC32C73[5][0]),(c3C4)));var sumcnt293_sum=((true&&tmp292)&&tmp291);var sumcnt293_cnt=2;arr3xE32E73[5][0]=(((andgeneral(0,sumcnt293_sum,sumcnt293_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[5][0]=(((var_eq((arr3xC32C73[5][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[7]=(c2B20);arr3xC32C73[6][0]=(c2D20);row3xC31C72[7]=arr3xC32C73[6][0];
 var tmp297=(var_ge((arr3xC32C73[6][0]),(c3C10)));var tmp298=(var_ls((arr3xC32C73[6][0]),(c3C4)));var sumcnt299_sum=((true&&tmp298)&&tmp297);var sumcnt299_cnt=2;arr3xE32E73[6][0]=(((andgeneral(0,sumcnt299_sum,sumcnt299_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[6][0]=(((var_eq((arr3xC32C73[6][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[8]=(c2B21);arr3xC32C73[7][0]=(c2D21);row3xC31C72[8]=arr3xC32C73[7][0];var tmp303=(var_ge((arr3xC32C73[7][0]),(c3C10)));var tmp304=(var_ls((arr3xC32C73[7][0]),(c3C4)));var sumcnt305_sum=((true&&tmp304)&&tmp303);var sumcnt305_cnt=2;arr3xE32E73[7][0]=(((andgeneral(0,sumcnt305_sum,sumcnt305_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[7][0]=(((var_eq((arr3xC32C73[7][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[9]=(c2B22);arr3xC32C73[8][0]=(c2D22);row3xC31C72[9]=arr3xC32C73[8][0];var tmp309=(var_ge((arr3xC32C73[8][0]),(c3C10)));var tmp310=(var_ls((arr3xC32C73[8][0]),(c3C4)));var sumcnt311_sum=((true&&tmp310)&&tmp309);var sumcnt311_cnt=2;arr3xE32E73[8][0]=(((andgeneral(0,sumcnt311_sum,sumcnt311_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[8][0]=(((var_eq((arr3xC32C73[8][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[10]=(c2B23);arr3xC32C73[9][0]=(c2D23);row3xC31C72[10]=arr3xC32C73[9][0];var tmp315=(var_ge((arr3xC32C73[9][0]),(c3C10)));var tmp316=(var_ls((arr3xC32C73[9][0]),(c3C4)));var sumcnt317_sum=((true&&tmp316)&&tmp315);var sumcnt317_cnt=2;arr3xE32E73[9][0]=(((andgeneral(0,sumcnt317_sum,sumcnt317_cnt,eecm1))?(c3C11):(0)));
 arr3xF32F73[9][0]=(((var_eq((arr3xC32C73[9][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[11]=(c2B24);arr3xC32C73[10][0]=(c2D24);row3xC31C72[11]=arr3xC32C73[10][0];var tmp321=(var_ge((arr3xC32C73[10][0]),(c3C10)));var tmp322=(var_ls((arr3xC32C73[10][0]),(c3C4)));var sumcnt323_sum=((true&&tmp322)&&tmp321);var sumcnt323_cnt=2;arr3xE32E73[10][0]=(((andgeneral(0,sumcnt323_sum,sumcnt323_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[10][0]=(((var_eq((arr3xC32C73[10][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[12]=(c2B25);arr3xC32C73[11][0]=(c2D25);row3xC31C72[12]=arr3xC32C73[11][0];var tmp327=(var_ge((arr3xC32C73[11][0]),(c3C10)));var tmp328=(var_ls((arr3xC32C73[11][0]),(c3C4)));var sumcnt329_sum=((true&&tmp328)&&tmp327);var sumcnt329_cnt=2;arr3xE32E73[11][0]=(((andgeneral(0,sumcnt329_sum,sumcnt329_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[11][0]=(((var_eq((arr3xC32C73[11][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[13]=(c2B26);arr3xC32C73[12][0]=(c2D26);row3xC31C72[13]=arr3xC32C73[12][0];var tmp333=(var_ge((arr3xC32C73[12][0]),(c3C10)));var tmp334=(var_ls((arr3xC32C73[12][0]),(c3C4)));var sumcnt335_sum=((true&&tmp334)&&tmp333);var sumcnt335_cnt=2;arr3xE32E73[12][0]=(((andgeneral(0,sumcnt335_sum,sumcnt335_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[12][0]=(((var_eq((arr3xC32C73[12][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[14]=(c2B27);arr3xC32C73[13][0]=(c2D27);row3xC31C72[14]=arr3xC32C73[13][0];
 var tmp339=(var_ge((arr3xC32C73[13][0]),(c3C10)));var tmp340=(var_ls((arr3xC32C73[13][0]),(c3C4)));var sumcnt341_sum=((true&&tmp340)&&tmp339);var sumcnt341_cnt=2;arr3xE32E73[13][0]=(((andgeneral(0,sumcnt341_sum,sumcnt341_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[13][0]=(((var_eq((arr3xC32C73[13][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[15]=(c2B28);arr3xC32C73[14][0]=(c2D28);row3xC31C72[15]=arr3xC32C73[14][0];var tmp345=(var_ge((arr3xC32C73[14][0]),(c3C10)));var tmp346=(var_ls((arr3xC32C73[14][0]),(c3C4)));var sumcnt347_sum=((true&&tmp346)&&tmp345);var sumcnt347_cnt=2;arr3xE32E73[14][0]=(((andgeneral(0,sumcnt347_sum,sumcnt347_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[14][0]=(((var_eq((arr3xC32C73[14][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[16]=(c2B29);arr3xC32C73[15][0]=(c2D29);row3xC31C72[16]=arr3xC32C73[15][0];var tmp351=(var_ge((arr3xC32C73[15][0]),(c3C10)));var tmp352=(var_ls((arr3xC32C73[15][0]),(c3C4)));var sumcnt353_sum=((true&&tmp352)&&tmp351);var sumcnt353_cnt=2;arr3xE32E73[15][0]=(((andgeneral(0,sumcnt353_sum,sumcnt353_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[15][0]=(((var_eq((arr3xC32C73[15][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[17]=(c2B30);arr3xC32C73[16][0]=(c2D30);row3xC31C72[17]=arr3xC32C73[16][0];var tmp357=(var_ge((arr3xC32C73[16][0]),(c3C10)));var tmp358=(var_ls((arr3xC32C73[16][0]),(c3C4)));var sumcnt359_sum=((true&&tmp358)&&tmp357);var sumcnt359_cnt=2;arr3xE32E73[16][0]=(((andgeneral(0,sumcnt359_sum,sumcnt359_cnt,eecm1))?(c3C11):(0)));
 arr3xF32F73[16][0]=(((var_eq((arr3xC32C73[16][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[18]=(c2B31);arr3xC32C73[17][0]=(c2D31);row3xC31C72[18]=arr3xC32C73[17][0];var tmp363=(var_ge((arr3xC32C73[17][0]),(c3C10)));var tmp364=(var_ls((arr3xC32C73[17][0]),(c3C4)));var sumcnt365_sum=((true&&tmp364)&&tmp363);var sumcnt365_cnt=2;arr3xE32E73[17][0]=(((andgeneral(0,sumcnt365_sum,sumcnt365_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[17][0]=(((var_eq((arr3xC32C73[17][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[19]=(c2B32);arr3xC32C73[18][0]=(c2D32);row3xC31C72[19]=arr3xC32C73[18][0];var tmp369=(var_ge((arr3xC32C73[18][0]),(c3C10)));var tmp370=(var_ls((arr3xC32C73[18][0]),(c3C4)));var sumcnt371_sum=((true&&tmp370)&&tmp369);var sumcnt371_cnt=2;arr3xE32E73[18][0]=(((andgeneral(0,sumcnt371_sum,sumcnt371_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[18][0]=(((var_eq((arr3xC32C73[18][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[20]=(c2B33);arr3xC32C73[19][0]=(c2D33);row3xC31C72[20]=arr3xC32C73[19][0];var tmp375=(var_ge((arr3xC32C73[19][0]),(c3C10)));var tmp376=(var_ls((arr3xC32C73[19][0]),(c3C4)));var sumcnt377_sum=((true&&tmp376)&&tmp375);var sumcnt377_cnt=2;arr3xE32E73[19][0]=(((andgeneral(0,sumcnt377_sum,sumcnt377_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[19][0]=(((var_eq((arr3xC32C73[19][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[21]=(c2B34);arr3xC32C73[20][0]=(c2D34);row3xC31C72[21]=arr3xC32C73[20][0];
 var tmp381=(var_ge((arr3xC32C73[20][0]),(c3C10)));var tmp382=(var_ls((arr3xC32C73[20][0]),(c3C4)));var sumcnt383_sum=((true&&tmp382)&&tmp381);var sumcnt383_cnt=2;arr3xE32E73[20][0]=(((andgeneral(0,sumcnt383_sum,sumcnt383_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[20][0]=(((var_eq((arr3xC32C73[20][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[22]=(c2B35);arr3xC32C73[21][0]=(c2D35);row3xC31C72[22]=arr3xC32C73[21][0];var tmp387=(var_ge((arr3xC32C73[21][0]),(c3C10)));var tmp388=(var_ls((arr3xC32C73[21][0]),(c3C4)));var sumcnt389_sum=((true&&tmp388)&&tmp387);var sumcnt389_cnt=2;arr3xE32E73[21][0]=(((andgeneral(0,sumcnt389_sum,sumcnt389_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[21][0]=(((var_eq((arr3xC32C73[21][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[23]=(c2B36);arr3xC32C73[22][0]=(c2D36);row3xC31C72[23]=arr3xC32C73[22][0];var tmp393=(var_ge((arr3xC32C73[22][0]),(c3C10)));var tmp394=(var_ls((arr3xC32C73[22][0]),(c3C4)));var sumcnt395_sum=((true&&tmp394)&&tmp393);var sumcnt395_cnt=2;arr3xE32E73[22][0]=(((andgeneral(0,sumcnt395_sum,sumcnt395_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[22][0]=(((var_eq((arr3xC32C73[22][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[24]=(c2B37);arr3xC32C73[23][0]=(c2D37);row3xC31C72[24]=arr3xC32C73[23][0];var tmp399=(var_ge((arr3xC32C73[23][0]),(c3C10)));var tmp400=(var_ls((arr3xC32C73[23][0]),(c3C4)));var sumcnt401_sum=((true&&tmp400)&&tmp399);var sumcnt401_cnt=2;arr3xE32E73[23][0]=(((andgeneral(0,sumcnt401_sum,sumcnt401_cnt,eecm1))?(c3C11):(0)));
 arr3xF32F73[23][0]=(((var_eq((arr3xC32C73[23][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[25]=(c2B38);arr3xC32C73[24][0]=(c2D38);row3xC31C72[25]=arr3xC32C73[24][0];var tmp405=(var_ge((arr3xC32C73[24][0]),(c3C10)));var tmp406=(var_ls((arr3xC32C73[24][0]),(c3C4)));var sumcnt407_sum=((true&&tmp406)&&tmp405);var sumcnt407_cnt=2;arr3xE32E73[24][0]=(((andgeneral(0,sumcnt407_sum,sumcnt407_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[24][0]=(((var_eq((arr3xC32C73[24][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[26]=(c2B39);arr3xC32C73[25][0]=(c2D39);row3xC31C72[26]=arr3xC32C73[25][0];var tmp411=(var_ge((arr3xC32C73[25][0]),(c3C10)));var tmp412=(var_ls((arr3xC32C73[25][0]),(c3C4)));var sumcnt413_sum=((true&&tmp412)&&tmp411);var sumcnt413_cnt=2;arr3xE32E73[25][0]=(((andgeneral(0,sumcnt413_sum,sumcnt413_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[25][0]=(((var_eq((arr3xC32C73[25][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[27]=(c2B40);arr3xC32C73[26][0]=(c2D40);row3xC31C72[27]=arr3xC32C73[26][0];var tmp417=(var_ge((arr3xC32C73[26][0]),(c3C10)));var tmp418=(var_ls((arr3xC32C73[26][0]),(c3C4)));var sumcnt419_sum=((true&&tmp418)&&tmp417);var sumcnt419_cnt=2;arr3xE32E73[26][0]=(((andgeneral(0,sumcnt419_sum,sumcnt419_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[26][0]=(((var_eq((arr3xC32C73[26][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[28]=(c2B41);arr3xC32C73[27][0]=(c2D41);row3xC31C72[28]=arr3xC32C73[27][0];
 var tmp423=(var_ge((arr3xC32C73[27][0]),(c3C10)));var tmp424=(var_ls((arr3xC32C73[27][0]),(c3C4)));var sumcnt425_sum=((true&&tmp424)&&tmp423);var sumcnt425_cnt=2;arr3xE32E73[27][0]=(((andgeneral(0,sumcnt425_sum,sumcnt425_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[27][0]=(((var_eq((arr3xC32C73[27][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[29]=(c2B42);arr3xC32C73[28][0]=(c2D42);row3xC31C72[29]=arr3xC32C73[28][0];var tmp429=(var_ge((arr3xC32C73[28][0]),(c3C10)));var tmp430=(var_ls((arr3xC32C73[28][0]),(c3C4)));var sumcnt431_sum=((true&&tmp430)&&tmp429);var sumcnt431_cnt=2;arr3xE32E73[28][0]=(((andgeneral(0,sumcnt431_sum,sumcnt431_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[28][0]=(((var_eq((arr3xC32C73[28][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[30]=(c2B43);arr3xC32C73[29][0]=(c2D43);row3xC31C72[30]=arr3xC32C73[29][0];var tmp435=(var_ge((arr3xC32C73[29][0]),(c3C10)));var tmp436=(var_ls((arr3xC32C73[29][0]),(c3C4)));var sumcnt437_sum=((true&&tmp436)&&tmp435);var sumcnt437_cnt=2;arr3xE32E73[29][0]=(((andgeneral(0,sumcnt437_sum,sumcnt437_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[29][0]=(((var_eq((arr3xC32C73[29][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[31]=(c2B44);arr3xC32C73[30][0]=(c2D44);row3xC31C72[31]=arr3xC32C73[30][0];var tmp441=(var_ge((arr3xC32C73[30][0]),(c3C10)));var tmp442=(var_ls((arr3xC32C73[30][0]),(c3C4)));var sumcnt443_sum=((true&&tmp442)&&tmp441);var sumcnt443_cnt=2;arr3xE32E73[30][0]=(((andgeneral(0,sumcnt443_sum,sumcnt443_cnt,eecm1))?(c3C11):(0)));
 arr3xF32F73[30][0]=(((var_eq((arr3xC32C73[30][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[32]=(c2B45);arr3xC32C73[31][0]=(c2D45);row3xC31C72[32]=arr3xC32C73[31][0];var tmp447=(var_ge((arr3xC32C73[31][0]),(c3C10)));var tmp448=(var_ls((arr3xC32C73[31][0]),(c3C4)));var sumcnt449_sum=((true&&tmp448)&&tmp447);var sumcnt449_cnt=2;arr3xE32E73[31][0]=(((andgeneral(0,sumcnt449_sum,sumcnt449_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[31][0]=(((var_eq((arr3xC32C73[31][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[33]=(c2B46);arr3xC32C73[32][0]=(c2D46);row3xC31C72[33]=arr3xC32C73[32][0];var tmp453=(var_ge((arr3xC32C73[32][0]),(c3C10)));var tmp454=(var_ls((arr3xC32C73[32][0]),(c3C4)));var sumcnt455_sum=((true&&tmp454)&&tmp453);var sumcnt455_cnt=2;arr3xE32E73[32][0]=(((andgeneral(0,sumcnt455_sum,sumcnt455_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[32][0]=(((var_eq((arr3xC32C73[32][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[34]=(c2B47);arr3xC32C73[33][0]=(c2D47);row3xC31C72[34]=arr3xC32C73[33][0];var tmp459=(var_ge((arr3xC32C73[33][0]),(c3C10)));var tmp460=(var_ls((arr3xC32C73[33][0]),(c3C4)));var sumcnt461_sum=((true&&tmp460)&&tmp459);var sumcnt461_cnt=2;arr3xE32E73[33][0]=(((andgeneral(0,sumcnt461_sum,sumcnt461_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[33][0]=(((var_eq((arr3xC32C73[33][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[35]=(c2B48);arr3xC32C73[34][0]=(c2D48);row3xC31C72[35]=arr3xC32C73[34][0];
 var tmp465=(var_ge((arr3xC32C73[34][0]),(c3C10)));var tmp466=(var_ls((arr3xC32C73[34][0]),(c3C4)));var sumcnt467_sum=((true&&tmp466)&&tmp465);var sumcnt467_cnt=2;arr3xE32E73[34][0]=(((andgeneral(0,sumcnt467_sum,sumcnt467_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[34][0]=(((var_eq((arr3xC32C73[34][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[36]=(c2B49);arr3xC32C73[35][0]=(c2D49);row3xC31C72[36]=arr3xC32C73[35][0];var tmp471=(var_ge((arr3xC32C73[35][0]),(c3C10)));var tmp472=(var_ls((arr3xC32C73[35][0]),(c3C4)));var sumcnt473_sum=((true&&tmp472)&&tmp471);var sumcnt473_cnt=2;arr3xE32E73[35][0]=(((andgeneral(0,sumcnt473_sum,sumcnt473_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[35][0]=(((var_eq((arr3xC32C73[35][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[37]=(c2B50);arr3xC32C73[36][0]=(c2D50);row3xC31C72[37]=arr3xC32C73[36][0];var tmp477=(var_ge((arr3xC32C73[36][0]),(c3C10)));var tmp478=(var_ls((arr3xC32C73[36][0]),(c3C4)));var sumcnt479_sum=((true&&tmp478)&&tmp477);var sumcnt479_cnt=2;arr3xE32E73[36][0]=(((andgeneral(0,sumcnt479_sum,sumcnt479_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[36][0]=(((var_eq((arr3xC32C73[36][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[38]=(c2B51);arr3xC32C73[37][0]=(c2D51);row3xC31C72[38]=arr3xC32C73[37][0];var tmp483=(var_ge((arr3xC32C73[37][0]),(c3C10)));var tmp484=(var_ls((arr3xC32C73[37][0]),(c3C4)));var sumcnt485_sum=((true&&tmp484)&&tmp483);var sumcnt485_cnt=2;arr3xE32E73[37][0]=(((andgeneral(0,sumcnt485_sum,sumcnt485_cnt,eecm1))?(c3C11):(0)));
 arr3xF32F73[37][0]=(((var_eq((arr3xC32C73[37][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[39]=(c2B52);arr3xC32C73[38][0]=(c2D52);row3xC31C72[39]=arr3xC32C73[38][0];var tmp489=(var_ge((arr3xC32C73[38][0]),(c3C10)));var tmp490=(var_ls((arr3xC32C73[38][0]),(c3C4)));var sumcnt491_sum=((true&&tmp490)&&tmp489);var sumcnt491_cnt=2;arr3xE32E73[38][0]=(((andgeneral(0,sumcnt491_sum,sumcnt491_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[38][0]=(((var_eq((arr3xC32C73[38][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[40]=(c2B53);arr3xC32C73[39][0]=(c2D53);row3xC31C72[40]=arr3xC32C73[39][0];var tmp495=(var_ge((arr3xC32C73[39][0]),(c3C10)));var tmp496=(var_ls((arr3xC32C73[39][0]),(c3C4)));var sumcnt497_sum=((true&&tmp496)&&tmp495);var sumcnt497_cnt=2;arr3xE32E73[39][0]=(((andgeneral(0,sumcnt497_sum,sumcnt497_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[39][0]=(((var_eq((arr3xC32C73[39][0]),(c3C10)))?(c3C7):(0)));row3xB31B72[41]=(c2B54);arr3xC32C73[40][0]=(c2D54);row3xC31C72[41]=arr3xC32C73[40][0];var tmp498=(var_ge((arr3xC32C73[40][0]),(c3C4)));var tmp499=(var_le((arr3xC32C73[40][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt500_sum=((true&&tmp499)&&tmp498);var sumcnt500_cnt=2;arr3xD32D73[40][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt500_sum,sumcnt500_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp501=(var_ge((arr3xC32C73[40][0]),(c3C10)));var tmp502=(var_ls((arr3xC32C73[40][0]),(c3C4)));var sumcnt503_sum=((true&&tmp502)&&tmp501);var sumcnt503_cnt=2;arr3xE32E73[40][0]=(((andgeneral(0,sumcnt503_sum,sumcnt503_cnt,eecm1))?(c3C11):(0)));
 arr3xF32F73[40][0]=(((var_eq((arr3xC32C73[40][0]),(c3C10)))?(c3C7):(0)));var c3B73=(c2B55);arr3xC32C73[41][0]=(c2D55);var tmp504=(var_ge((arr3xC32C73[41][0]),(c3C4)));var tmp505=(var_le((arr3xC32C73[41][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt506_sum=((true&&tmp505)&&tmp504);var sumcnt506_cnt=2;arr3xD32D73[41][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt506_sum,sumcnt506_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp507=(var_ge((arr3xC32C73[41][0]),(c3C10)));var tmp508=(var_ls((arr3xC32C73[41][0]),(c3C4)));var sumcnt509_sum=((true&&tmp508)&&tmp507);var sumcnt509_cnt=2;arr3xE32E73[41][0]=(((andgeneral(0,sumcnt509_sum,sumcnt509_cnt,eecm1))?(c3C11):(0)));arr3xF32F73[41][0]=(((var_eq((arr3xC32C73[41][0]),(c3C10)))?(c3C7):(0)));var tmp258=(var_ge((arr3xC32C73[0][0]),(c3C4)));var tmp259=(var_le((arr3xC32C73[0][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt260_sum=((true&&tmp259)&&tmp258);var sumcnt260_cnt=2;arr3xD32D73[0][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt260_sum,sumcnt260_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp264=(var_ge((arr3xC32C73[1][0]),(c3C4)));var tmp265=(var_le((arr3xC32C73[1][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt266_sum=((true&&tmp265)&&tmp264);var sumcnt266_cnt=2;arr3xD32D73[1][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt266_sum,sumcnt266_cnt,eecm1))?(c3C9):(0))))*(12)));
 var tmp270=(var_ge((arr3xC32C73[2][0]),(c3C4)));var tmp271=(var_le((arr3xC32C73[2][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt272_sum=((true&&tmp271)&&tmp270);var sumcnt272_cnt=2;arr3xD32D73[2][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt272_sum,sumcnt272_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp276=(var_ge((arr3xC32C73[3][0]),(c3C4)));var tmp277=(var_le((arr3xC32C73[3][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt278_sum=((true&&tmp277)&&tmp276);var sumcnt278_cnt=2;arr3xD32D73[3][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt278_sum,sumcnt278_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp282=(var_ge((arr3xC32C73[4][0]),(c3C4)));var tmp283=(var_le((arr3xC32C73[4][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt284_sum=((true&&tmp283)&&tmp282);var sumcnt284_cnt=2;arr3xD32D73[4][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt284_sum,sumcnt284_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp288=(var_ge((arr3xC32C73[5][0]),(c3C4)));var tmp289=(var_le((arr3xC32C73[5][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt290_sum=((true&&tmp289)&&tmp288);var sumcnt290_cnt=2;arr3xD32D73[5][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt290_sum,sumcnt290_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp294=(var_ge((arr3xC32C73[6][0]),(c3C4)));var tmp295=(var_le((arr3xC32C73[6][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt296_sum=((true&&tmp295)&&tmp294);var sumcnt296_cnt=2;arr3xD32D73[6][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt296_sum,sumcnt296_cnt,eecm1))?(c3C9):(0))))*(12)));
 var tmp300=(var_ge((arr3xC32C73[7][0]),(c3C4)));var tmp301=(var_le((arr3xC32C73[7][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt302_sum=((true&&tmp301)&&tmp300);var sumcnt302_cnt=2;arr3xD32D73[7][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt302_sum,sumcnt302_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp306=(var_ge((arr3xC32C73[8][0]),(c3C4)));var tmp307=(var_le((arr3xC32C73[8][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt308_sum=((true&&tmp307)&&tmp306);var sumcnt308_cnt=2;arr3xD32D73[8][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt308_sum,sumcnt308_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp312=(var_ge((arr3xC32C73[9][0]),(c3C4)));var tmp313=(var_le((arr3xC32C73[9][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt314_sum=((true&&tmp313)&&tmp312);var sumcnt314_cnt=2;arr3xD32D73[9][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt314_sum,sumcnt314_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp318=(var_ge((arr3xC32C73[10][0]),(c3C4)));var tmp319=(var_le((arr3xC32C73[10][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt320_sum=((true&&tmp319)&&tmp318);var sumcnt320_cnt=2;arr3xD32D73[10][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt320_sum,sumcnt320_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp324=(var_ge((arr3xC32C73[11][0]),(c3C4)));var tmp325=(var_le((arr3xC32C73[11][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt326_sum=((true&&tmp325)&&tmp324);var sumcnt326_cnt=2;arr3xD32D73[11][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt326_sum,sumcnt326_cnt,eecm1))?(c3C9):(0))))*(12)));
 var tmp330=(var_ge((arr3xC32C73[12][0]),(c3C4)));var tmp331=(var_le((arr3xC32C73[12][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt332_sum=((true&&tmp331)&&tmp330);var sumcnt332_cnt=2;arr3xD32D73[12][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt332_sum,sumcnt332_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp336=(var_ge((arr3xC32C73[13][0]),(c3C4)));var tmp337=(var_le((arr3xC32C73[13][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt338_sum=((true&&tmp337)&&tmp336);var sumcnt338_cnt=2;arr3xD32D73[13][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt338_sum,sumcnt338_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp342=(var_ge((arr3xC32C73[14][0]),(c3C4)));var tmp343=(var_le((arr3xC32C73[14][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt344_sum=((true&&tmp343)&&tmp342);var sumcnt344_cnt=2;arr3xD32D73[14][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt344_sum,sumcnt344_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp348=(var_ge((arr3xC32C73[15][0]),(c3C4)));var tmp349=(var_le((arr3xC32C73[15][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt350_sum=((true&&tmp349)&&tmp348);var sumcnt350_cnt=2;arr3xD32D73[15][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt350_sum,sumcnt350_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp354=(var_ge((arr3xC32C73[16][0]),(c3C4)));var tmp355=(var_le((arr3xC32C73[16][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt356_sum=((true&&tmp355)&&tmp354);var sumcnt356_cnt=2;arr3xD32D73[16][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt356_sum,sumcnt356_cnt,eecm1))?(c3C9):(0))))*(12)));
 var tmp360=(var_ge((arr3xC32C73[17][0]),(c3C4)));var tmp361=(var_le((arr3xC32C73[17][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt362_sum=((true&&tmp361)&&tmp360);var sumcnt362_cnt=2;arr3xD32D73[17][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt362_sum,sumcnt362_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp366=(var_ge((arr3xC32C73[18][0]),(c3C4)));var tmp367=(var_le((arr3xC32C73[18][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt368_sum=((true&&tmp367)&&tmp366);var sumcnt368_cnt=2;arr3xD32D73[18][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt368_sum,sumcnt368_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp372=(var_ge((arr3xC32C73[19][0]),(c3C4)));var tmp373=(var_le((arr3xC32C73[19][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt374_sum=((true&&tmp373)&&tmp372);var sumcnt374_cnt=2;arr3xD32D73[19][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt374_sum,sumcnt374_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp378=(var_ge((arr3xC32C73[20][0]),(c3C4)));var tmp379=(var_le((arr3xC32C73[20][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt380_sum=((true&&tmp379)&&tmp378);var sumcnt380_cnt=2;arr3xD32D73[20][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt380_sum,sumcnt380_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp384=(var_ge((arr3xC32C73[21][0]),(c3C4)));var tmp385=(var_le((arr3xC32C73[21][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt386_sum=((true&&tmp385)&&tmp384);var sumcnt386_cnt=2;arr3xD32D73[21][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt386_sum,sumcnt386_cnt,eecm1))?(c3C9):(0))))*(12)));
 var tmp390=(var_ge((arr3xC32C73[22][0]),(c3C4)));var tmp391=(var_le((arr3xC32C73[22][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt392_sum=((true&&tmp391)&&tmp390);var sumcnt392_cnt=2;arr3xD32D73[22][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt392_sum,sumcnt392_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp396=(var_ge((arr3xC32C73[23][0]),(c3C4)));var tmp397=(var_le((arr3xC32C73[23][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt398_sum=((true&&tmp397)&&tmp396);var sumcnt398_cnt=2;arr3xD32D73[23][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt398_sum,sumcnt398_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp402=(var_ge((arr3xC32C73[24][0]),(c3C4)));var tmp403=(var_le((arr3xC32C73[24][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt404_sum=((true&&tmp403)&&tmp402);var sumcnt404_cnt=2;arr3xD32D73[24][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt404_sum,sumcnt404_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp408=(var_ge((arr3xC32C73[25][0]),(c3C4)));var tmp409=(var_le((arr3xC32C73[25][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt410_sum=((true&&tmp409)&&tmp408);var sumcnt410_cnt=2;arr3xD32D73[25][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt410_sum,sumcnt410_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp414=(var_ge((arr3xC32C73[26][0]),(c3C4)));var tmp415=(var_le((arr3xC32C73[26][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt416_sum=((true&&tmp415)&&tmp414);var sumcnt416_cnt=2;arr3xD32D73[26][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt416_sum,sumcnt416_cnt,eecm1))?(c3C9):(0))))*(12)));
 var tmp420=(var_ge((arr3xC32C73[27][0]),(c3C4)));var tmp421=(var_le((arr3xC32C73[27][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt422_sum=((true&&tmp421)&&tmp420);var sumcnt422_cnt=2;arr3xD32D73[27][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt422_sum,sumcnt422_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp426=(var_ge((arr3xC32C73[28][0]),(c3C4)));var tmp427=(var_le((arr3xC32C73[28][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt428_sum=((true&&tmp427)&&tmp426);var sumcnt428_cnt=2;arr3xD32D73[28][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt428_sum,sumcnt428_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp432=(var_ge((arr3xC32C73[29][0]),(c3C4)));var tmp433=(var_le((arr3xC32C73[29][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt434_sum=((true&&tmp433)&&tmp432);var sumcnt434_cnt=2;arr3xD32D73[29][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt434_sum,sumcnt434_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp438=(var_ge((arr3xC32C73[30][0]),(c3C4)));var tmp439=(var_le((arr3xC32C73[30][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt440_sum=((true&&tmp439)&&tmp438);var sumcnt440_cnt=2;arr3xD32D73[30][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt440_sum,sumcnt440_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp444=(var_ge((arr3xC32C73[31][0]),(c3C4)));var tmp445=(var_le((arr3xC32C73[31][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt446_sum=((true&&tmp445)&&tmp444);var sumcnt446_cnt=2;arr3xD32D73[31][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt446_sum,sumcnt446_cnt,eecm1))?(c3C9):(0))))*(12)));
 var tmp450=(var_ge((arr3xC32C73[32][0]),(c3C4)));var tmp451=(var_le((arr3xC32C73[32][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt452_sum=((true&&tmp451)&&tmp450);var sumcnt452_cnt=2;arr3xD32D73[32][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt452_sum,sumcnt452_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp456=(var_ge((arr3xC32C73[33][0]),(c3C4)));var tmp457=(var_le((arr3xC32C73[33][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt458_sum=((true&&tmp457)&&tmp456);var sumcnt458_cnt=2;arr3xD32D73[33][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt458_sum,sumcnt458_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp462=(var_ge((arr3xC32C73[34][0]),(c3C4)));var tmp463=(var_le((arr3xC32C73[34][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt464_sum=((true&&tmp463)&&tmp462);var sumcnt464_cnt=2;arr3xD32D73[34][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt464_sum,sumcnt464_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp468=(var_ge((arr3xC32C73[35][0]),(c3C4)));var tmp469=(var_le((arr3xC32C73[35][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt470_sum=((true&&tmp469)&&tmp468);var sumcnt470_cnt=2;arr3xD32D73[35][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt470_sum,sumcnt470_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp474=(var_ge((arr3xC32C73[36][0]),(c3C4)));var tmp475=(var_le((arr3xC32C73[36][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt476_sum=((true&&tmp475)&&tmp474);var sumcnt476_cnt=2;arr3xD32D73[36][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt476_sum,sumcnt476_cnt,eecm1))?(c3C9):(0))))*(12)));
 var tmp480=(var_ge((arr3xC32C73[37][0]),(c3C4)));var tmp481=(var_le((arr3xC32C73[37][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt482_sum=((true&&tmp481)&&tmp480);var sumcnt482_cnt=2;arr3xD32D73[37][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt482_sum,sumcnt482_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp486=(var_ge((arr3xC32C73[38][0]),(c3C4)));var tmp487=(var_le((arr3xC32C73[38][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt488_sum=((true&&tmp487)&&tmp486);var sumcnt488_cnt=2;arr3xD32D73[38][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt488_sum,sumcnt488_cnt,eecm1))?(c3C9):(0))))*(12)));var tmp492=(var_ge((arr3xC32C73[39][0]),(c3C4)));var tmp493=(var_le((arr3xC32C73[39][0]),(lookup3vv_var((c3D5),row3xB31B72,0,41,row3xC31C72,0,41))));var sumcnt494_sum=((true&&tmp493)&&tmp492);var sumcnt494_cnt=2;arr3xD32D73[39][0]=(((((var_eq((c3C4),("")))?(0):((andgeneral(0,sumcnt494_sum,sumcnt494_cnt,eecm1))?(c3C9):(0))))*(12)));var c8D1=(sscgetter(arr3xC32C73,0,0,41,0,("Annuity!$C$32:$C$73"),("Annuity!$C$32:$C$73")));var c8G1=(sscgetter_numonly(arr3xE32E73,0,0,41,0,("Annuity!$E$32:$E$73"),("Annuity!$E$32:$E$73_numonly")));var c8H1=(sscgetter_numonly(arr3xF32F73,0,0,41,0,("Annuity!$F$32:$F$73"),("Annuity!$F$32:$F$73_numonly")));var c8I1=(sscgetter_numonly(arr3xD32D73,0,0,41,0,("Annuity!$D$32:$D$73"),("Annuity!$D$32:$D$73_numonly")));data['XLEW_3_73_6']=arr3xF32F73[41][0];
 data['XLEW_3_73_5']=arr3xE32E73[41][0];data['XLEW_3_73_4']=arr3xD32D73[41][0];data['XLEW_3_73_3']=arr3xC32C73[41][0];data['XLEW_3_73_2']=c3B73;data['XLEW_3_72_6']=arr3xF32F73[40][0];data['XLEW_3_72_5']=arr3xE32E73[40][0];data['XLEW_3_72_4']=arr3xD32D73[40][0];data['XLEW_3_72_3']=arr3xC32C73[40][0];data['XLEW_3_72_2']=row3xB31B72[41];data['XLEW_3_71_6']=arr3xF32F73[39][0];data['XLEW_3_71_5']=arr3xE32E73[39][0];data['XLEW_3_71_4']=arr3xD32D73[39][0];data['XLEW_3_71_3']=arr3xC32C73[39][0];data['XLEW_3_71_2']=row3xB31B72[40];data['XLEW_3_70_6']=arr3xF32F73[38][0];data['XLEW_3_70_5']=arr3xE32E73[38][0];data['XLEW_3_70_4']=arr3xD32D73[38][0];data['XLEW_3_70_3']=arr3xC32C73[38][0];data['XLEW_3_70_2']=row3xB31B72[39];data['XLEW_3_69_6']=arr3xF32F73[37][0];data['XLEW_3_69_5']=arr3xE32E73[37][0];data['XLEW_3_69_4']=arr3xD32D73[37][0];data['XLEW_3_69_3']=arr3xC32C73[37][0];data['XLEW_3_69_2']=row3xB31B72[38];data['XLEW_3_68_6']=arr3xF32F73[36][0];data['XLEW_3_68_5']=arr3xE32E73[36][0];data['XLEW_3_68_4']=arr3xD32D73[36][0];data['XLEW_3_68_3']=arr3xC32C73[36][0];data['XLEW_3_68_2']=row3xB31B72[37];data['XLEW_3_67_6']=arr3xF32F73[35][0];data['XLEW_3_67_5']=arr3xE32E73[35][0];data['XLEW_3_67_4']=arr3xD32D73[35][0];data['XLEW_3_67_3']=arr3xC32C73[35][0];data['XLEW_3_67_2']=row3xB31B72[36];data['XLEW_3_66_6']=arr3xF32F73[34][0];data['XLEW_3_66_5']=arr3xE32E73[34][0];
 data['XLEW_3_66_4']=arr3xD32D73[34][0];data['XLEW_3_66_3']=arr3xC32C73[34][0];data['XLEW_3_66_2']=row3xB31B72[35];data['XLEW_3_65_6']=arr3xF32F73[33][0];data['XLEW_3_65_5']=arr3xE32E73[33][0];data['XLEW_3_65_4']=arr3xD32D73[33][0];data['XLEW_3_65_3']=arr3xC32C73[33][0];data['XLEW_3_65_2']=row3xB31B72[34];data['XLEW_3_64_6']=arr3xF32F73[32][0];data['XLEW_3_64_5']=arr3xE32E73[32][0];data['XLEW_3_64_4']=arr3xD32D73[32][0];data['XLEW_3_64_3']=arr3xC32C73[32][0];data['XLEW_3_64_2']=row3xB31B72[33];data['XLEW_3_63_6']=arr3xF32F73[31][0];data['XLEW_3_63_5']=arr3xE32E73[31][0];data['XLEW_3_63_4']=arr3xD32D73[31][0];data['XLEW_3_63_3']=arr3xC32C73[31][0];data['XLEW_3_63_2']=row3xB31B72[32];data['XLEW_3_62_6']=arr3xF32F73[30][0];data['XLEW_3_62_5']=arr3xE32E73[30][0];data['XLEW_3_62_4']=arr3xD32D73[30][0];data['XLEW_3_62_3']=arr3xC32C73[30][0];data['XLEW_3_62_2']=row3xB31B72[31];data['XLEW_3_61_6']=arr3xF32F73[29][0];data['XLEW_3_61_5']=arr3xE32E73[29][0];data['XLEW_3_61_4']=arr3xD32D73[29][0];data['XLEW_3_61_3']=arr3xC32C73[29][0];data['XLEW_3_61_2']=row3xB31B72[30];data['XLEW_3_60_6']=arr3xF32F73[28][0];data['XLEW_3_60_5']=arr3xE32E73[28][0];data['XLEW_3_60_4']=arr3xD32D73[28][0];data['XLEW_3_60_3']=arr3xC32C73[28][0];data['XLEW_3_60_2']=row3xB31B72[29];data['XLEW_3_59_6']=arr3xF32F73[27][0];data['XLEW_3_59_5']=arr3xE32E73[27][0];data['XLEW_3_59_4']=arr3xD32D73[27][0];
 data['XLEW_3_59_3']=arr3xC32C73[27][0];data['XLEW_3_59_2']=row3xB31B72[28];data['XLEW_3_58_6']=arr3xF32F73[26][0];data['XLEW_3_58_5']=arr3xE32E73[26][0];data['XLEW_3_58_4']=arr3xD32D73[26][0];data['XLEW_3_58_3']=arr3xC32C73[26][0];data['XLEW_3_58_2']=row3xB31B72[27];data['XLEW_3_57_6']=arr3xF32F73[25][0];data['XLEW_3_57_5']=arr3xE32E73[25][0];data['XLEW_3_57_4']=arr3xD32D73[25][0];data['XLEW_3_57_3']=arr3xC32C73[25][0];data['XLEW_3_57_2']=row3xB31B72[26];data['XLEW_3_56_6']=arr3xF32F73[24][0];data['XLEW_3_56_5']=arr3xE32E73[24][0];data['XLEW_3_56_4']=arr3xD32D73[24][0];data['XLEW_3_56_3']=arr3xC32C73[24][0];data['XLEW_3_56_2']=row3xB31B72[25];data['XLEW_3_55_6']=arr3xF32F73[23][0];data['XLEW_3_55_5']=arr3xE32E73[23][0];data['XLEW_3_55_4']=arr3xD32D73[23][0];data['XLEW_3_55_3']=arr3xC32C73[23][0];data['XLEW_3_55_2']=row3xB31B72[24];data['XLEW_3_54_6']=arr3xF32F73[22][0];data['XLEW_3_54_5']=arr3xE32E73[22][0];data['XLEW_3_54_4']=arr3xD32D73[22][0];data['XLEW_3_54_3']=arr3xC32C73[22][0];data['XLEW_3_54_2']=row3xB31B72[23];data['XLEW_3_53_6']=arr3xF32F73[21][0];data['XLEW_3_53_5']=arr3xE32E73[21][0];data['XLEW_3_53_4']=arr3xD32D73[21][0];data['XLEW_3_53_3']=arr3xC32C73[21][0];data['XLEW_3_53_2']=row3xB31B72[22];data['XLEW_3_52_6']=arr3xF32F73[20][0];data['XLEW_3_52_5']=arr3xE32E73[20][0];data['XLEW_3_52_4']=arr3xD32D73[20][0];data['XLEW_3_52_3']=arr3xC32C73[20][0];
 data['XLEW_3_52_2']=row3xB31B72[21];data['XLEW_3_51_6']=arr3xF32F73[19][0];data['XLEW_3_51_5']=arr3xE32E73[19][0];data['XLEW_3_51_4']=arr3xD32D73[19][0];data['XLEW_3_51_3']=arr3xC32C73[19][0];data['XLEW_3_51_2']=row3xB31B72[20];data['XLEW_3_50_6']=arr3xF32F73[18][0];data['XLEW_3_50_5']=arr3xE32E73[18][0];data['XLEW_3_50_4']=arr3xD32D73[18][0];data['XLEW_3_50_3']=arr3xC32C73[18][0];data['XLEW_3_50_2']=row3xB31B72[19];data['XLEW_3_49_6']=arr3xF32F73[17][0];data['XLEW_3_49_5']=arr3xE32E73[17][0];data['XLEW_3_49_4']=arr3xD32D73[17][0];data['XLEW_3_49_3']=arr3xC32C73[17][0];data['XLEW_3_49_2']=row3xB31B72[18];data['XLEW_3_48_6']=arr3xF32F73[16][0];data['XLEW_3_48_5']=arr3xE32E73[16][0];data['XLEW_3_48_4']=arr3xD32D73[16][0];data['XLEW_3_48_3']=arr3xC32C73[16][0];data['XLEW_3_48_2']=row3xB31B72[17];data['XLEW_3_47_6']=arr3xF32F73[15][0];data['XLEW_3_47_5']=arr3xE32E73[15][0];data['XLEW_3_47_4']=arr3xD32D73[15][0];data['XLEW_3_47_3']=arr3xC32C73[15][0];data['XLEW_3_47_2']=row3xB31B72[16];data['XLEW_3_46_6']=arr3xF32F73[14][0];data['XLEW_3_46_5']=arr3xE32E73[14][0];data['XLEW_3_46_4']=arr3xD32D73[14][0];data['XLEW_3_46_3']=arr3xC32C73[14][0];data['XLEW_3_46_2']=row3xB31B72[15];data['XLEW_3_45_6']=arr3xF32F73[13][0];data['XLEW_3_45_5']=arr3xE32E73[13][0];data['XLEW_3_45_4']=arr3xD32D73[13][0];data['XLEW_3_45_3']=arr3xC32C73[13][0];data['XLEW_3_45_2']=row3xB31B72[14];
 data['XLEW_3_44_6']=arr3xF32F73[12][0];data['XLEW_3_44_5']=arr3xE32E73[12][0];data['XLEW_3_44_4']=arr3xD32D73[12][0];data['XLEW_3_44_3']=arr3xC32C73[12][0];data['XLEW_3_44_2']=row3xB31B72[13];data['XLEW_3_43_6']=arr3xF32F73[11][0];data['XLEW_3_43_5']=arr3xE32E73[11][0];data['XLEW_3_43_4']=arr3xD32D73[11][0];data['XLEW_3_43_3']=arr3xC32C73[11][0];data['XLEW_3_43_2']=row3xB31B72[12];data['XLEW_3_42_6']=arr3xF32F73[10][0];data['XLEW_3_42_5']=arr3xE32E73[10][0];data['XLEW_3_42_4']=arr3xD32D73[10][0];data['XLEW_3_42_3']=arr3xC32C73[10][0];data['XLEW_3_42_2']=row3xB31B72[11];data['XLEW_3_41_6']=arr3xF32F73[9][0];data['XLEW_3_41_5']=arr3xE32E73[9][0];data['XLEW_3_41_4']=arr3xD32D73[9][0];data['XLEW_3_41_3']=arr3xC32C73[9][0];data['XLEW_3_41_2']=row3xB31B72[10];data['XLEW_3_40_6']=arr3xF32F73[8][0];data['XLEW_3_40_5']=arr3xE32E73[8][0];data['XLEW_3_40_4']=arr3xD32D73[8][0];data['XLEW_3_40_3']=arr3xC32C73[8][0];data['XLEW_3_40_2']=row3xB31B72[9];data['XLEW_3_39_6']=arr3xF32F73[7][0];data['XLEW_3_39_5']=arr3xE32E73[7][0];data['XLEW_3_39_4']=arr3xD32D73[7][0];data['XLEW_3_39_3']=arr3xC32C73[7][0];data['XLEW_3_39_2']=row3xB31B72[8];data['XLEW_3_38_6']=arr3xF32F73[6][0];data['XLEW_3_38_5']=arr3xE32E73[6][0];data['XLEW_3_38_4']=arr3xD32D73[6][0];data['XLEW_3_38_3']=arr3xC32C73[6][0];data['XLEW_3_38_2']=row3xB31B72[7];data['XLEW_3_37_6']=arr3xF32F73[5][0];
 data['XLEW_3_37_5']=arr3xE32E73[5][0];data['XLEW_3_37_4']=arr3xD32D73[5][0];data['XLEW_3_37_3']=arr3xC32C73[5][0];data['XLEW_3_37_2']=row3xB31B72[6];data['XLEW_3_36_6']=arr3xF32F73[4][0];data['XLEW_3_36_5']=arr3xE32E73[4][0];data['XLEW_3_36_4']=arr3xD32D73[4][0];data['XLEW_3_36_3']=arr3xC32C73[4][0];data['XLEW_3_36_2']=row3xB31B72[5];data['XLEW_3_35_6']=arr3xF32F73[3][0];data['XLEW_3_35_5']=arr3xE32E73[3][0];data['XLEW_3_35_4']=arr3xD32D73[3][0];data['XLEW_3_35_3']=arr3xC32C73[3][0];data['XLEW_3_35_2']=row3xB31B72[4];data['XLEW_3_34_6']=arr3xF32F73[2][0];data['XLEW_3_34_5']=arr3xE32E73[2][0];data['XLEW_3_34_4']=arr3xD32D73[2][0];data['XLEW_3_34_3']=arr3xC32C73[2][0];data['XLEW_3_34_2']=row3xB31B72[3];data['XLEW_3_33_6']=arr3xF32F73[1][0];data['XLEW_3_33_5']=arr3xE32E73[1][0];data['XLEW_3_33_4']=arr3xD32D73[1][0];data['XLEW_3_33_3']=arr3xC32C73[1][0];data['XLEW_3_33_2']=row3xB31B72[2];data['XLEW_3_32_6']=arr3xF32F73[0][0];data['XLEW_3_32_5']=arr3xE32E73[0][0];data['XLEW_3_32_4']=arr3xD32D73[0][0];data['XLEW_3_32_3']=arr3xC32C73[0][0];data['XLEW_3_32_2']=row3xB31B72[1];data['XLEW_3_11_3']=c3C11;data['XLEW_3_6_3']=c3C6;data['XLEW_3_5_4']=c3D5;data['XLEW_3_4_4']=c3D4;};
...
function recalc_onclick(ctl) {ssc.recalcSource = ctl;
  if (true) {
co['XLEW_3_1_3']=eeparseFloat(document.getElementById('XLEW_3_1_3').value);co['XLEW_3_2_3']=eeparseFloat(document.getElementById('XLEW_3_2_3').value);co['XLEW_3_3_3']=eeparseFloat(document.getElementById('XLEW_3_3_3').value);co['XLEW_3_4_3']=eeparseFloatV(document.getElementById('XLEW_3_4_3').value);co['XLEW_3_5_3']=eeparseFloatV(document.getElementById('XLEW_3_5_3').value);co['XLEW_3_7_3']=eeparseFloat(document.getElementById('XLEW_3_7_3').value);co['XLEW_3_8_3']=eeparseFloat(document.getElementById('XLEW_3_8_3').value);co['XLEW_3_9_3']=eeparseFloat(document.getElementById('XLEW_3_9_3').value);co['XLEW_3_10_3']=eeparseFloatV(document.getElementById('XLEW_3_10_3').value);co['XLEW_3_30_2']=document.getElementById('XLEW_3_30_2').checked;EE.eeGlobalRevision++;calc(co);chart("all");document.getElementById('XLEW_3_4_4').value=eedisplayFloat(co['XLEW_3_4_4']);document.getElementById('XLEW_3_5_4').value=eedisplayFloat(co['XLEW_3_5_4']);document.getElementById('XLEW_3_6_3').value=eedatefmt(fmtdate2,co['XLEW_3_6_3']);document.getElementById('XLEW_3_11_3').value=eedatefmt(fmtdate3,co['XLEW_3_11_3']);document.getElementById('XLEW_3_32_2').value=eedisplayFloat(co['XLEW_3_32_2']);document.getElementById('XLEW_3_32_3').value=eedisplayFloat(co['XLEW_3_32_3']);document.getElementById('XLEW_3_32_4').value=eedatefmt(fmtdate1,co['XLEW_3_32_4']);document.getElementById('XLEW_3_32_5').value=eedatefmt(fmtdate1,co['XLEW_3_32_5']);document.getElementById('XLEW_3_32_6').value=eedatefmt(fmtdate1,co['XLEW_3_32_6']);
document.getElementById('XLEW_3_33_2').value=eedisplayFloat(co['XLEW_3_33_2']);document.getElementById('XLEW_3_33_3').value=eedisplayFloat(co['XLEW_3_33_3']);document.getElementById('XLEW_3_33_4').value=eedatefmt(fmtdate1,co['XLEW_3_33_4']);document.getElementById('XLEW_3_33_5').value=eedatefmt(fmtdate1,co['XLEW_3_33_5']);document.getElementById('XLEW_3_33_6').value=eedatefmt(fmtdate1,co['XLEW_3_33_6']);document.getElementById('XLEW_3_34_2').value=eedisplayFloat(co['XLEW_3_34_2']);document.getElementById('XLEW_3_34_3').value=eedisplayFloat(co['XLEW_3_34_3']);document.getElementById('XLEW_3_34_4').value=eedatefmt(fmtdate1,co['XLEW_3_34_4']);document.getElementById('XLEW_3_34_5').value=eedatefmt(fmtdate1,co['XLEW_3_34_5']);document.getElementById('XLEW_3_34_6').value=eedatefmt(fmtdate1,co['XLEW_3_34_6']);document.getElementById('XLEW_3_35_2').value=eedisplayFloat(co['XLEW_3_35_2']);document.getElementById('XLEW_3_35_3').value=eedisplayFloat(co['XLEW_3_35_3']);document.getElementById('XLEW_3_35_4').value=eedatefmt(fmtdate1,co['XLEW_3_35_4']);document.getElementById('XLEW_3_35_5').value=eedatefmt(fmtdate1,co['XLEW_3_35_5']);document.getElementById('XLEW_3_35_6').value=eedatefmt(fmtdate1,co['XLEW_3_35_6']);document.getElementById('XLEW_3_36_2').value=eedisplayFloat(co['XLEW_3_36_2']);document.getElementById('XLEW_3_36_3').value=eedisplayFloat(co['XLEW_3_36_3']);document.getElementById('XLEW_3_36_4').value=eedatefmt(fmtdate1,co['XLEW_3_36_4']);document.getElementById('XLEW_3_36_5').value=eedatefmt(fmtdate1,co['XLEW_3_36_5']);
document.getElementById('XLEW_3_36_6').value=eedatefmt(fmtdate1,co['XLEW_3_36_6']);document.getElementById('XLEW_3_37_2').value=eedisplayFloat(co['XLEW_3_37_2']);document.getElementById('XLEW_3_37_3').value=eedisplayFloat(co['XLEW_3_37_3']);document.getElementById('XLEW_3_37_4').value=eedatefmt(fmtdate1,co['XLEW_3_37_4']);document.getElementById('XLEW_3_37_5').value=eedatefmt(fmtdate1,co['XLEW_3_37_5']);document.getElementById('XLEW_3_37_6').value=eedatefmt(fmtdate1,co['XLEW_3_37_6']);document.getElementById('XLEW_3_38_2').value=eedisplayFloat(co['XLEW_3_38_2']);document.getElementById('XLEW_3_38_3').value=eedisplayFloat(co['XLEW_3_38_3']);document.getElementById('XLEW_3_38_4').value=eedatefmt(fmtdate1,co['XLEW_3_38_4']);document.getElementById('XLEW_3_38_5').value=eedatefmt(fmtdate1,co['XLEW_3_38_5']);document.getElementById('XLEW_3_38_6').value=eedatefmt(fmtdate1,co['XLEW_3_38_6']);document.getElementById('XLEW_3_39_2').value=eedisplayFloat(co['XLEW_3_39_2']);document.getElementById('XLEW_3_39_3').value=eedisplayFloat(co['XLEW_3_39_3']);document.getElementById('XLEW_3_39_4').value=eedatefmt(fmtdate1,co['XLEW_3_39_4']);document.getElementById('XLEW_3_39_5').value=eedatefmt(fmtdate1,co['XLEW_3_39_5']);document.getElementById('XLEW_3_39_6').value=eedatefmt(fmtdate1,co['XLEW_3_39_6']);document.getElementById('XLEW_3_40_2').value=eedisplayFloat(co['XLEW_3_40_2']);document.getElementById('XLEW_3_40_3').value=eedisplayFloat(co['XLEW_3_40_3']);document.getElementById('XLEW_3_40_4').value=eedatefmt(fmtdate1,co['XLEW_3_40_4']);
document.getElementById('XLEW_3_40_5').value=eedatefmt(fmtdate1,co['XLEW_3_40_5']);document.getElementById('XLEW_3_40_6').value=eedatefmt(fmtdate1,co['XLEW_3_40_6']);document.getElementById('XLEW_3_41_2').value=eedisplayFloat(co['XLEW_3_41_2']);document.getElementById('XLEW_3_41_3').value=eedisplayFloat(co['XLEW_3_41_3']);document.getElementById('XLEW_3_41_4').value=eedatefmt(fmtdate1,co['XLEW_3_41_4']);document.getElementById('XLEW_3_41_5').value=eedatefmt(fmtdate1,co['XLEW_3_41_5']);document.getElementById('XLEW_3_41_6').value=eedatefmt(fmtdate1,co['XLEW_3_41_6']);document.getElementById('XLEW_3_42_2').value=eedisplayFloat(co['XLEW_3_42_2']);document.getElementById('XLEW_3_42_3').value=eedisplayFloat(co['XLEW_3_42_3']);document.getElementById('XLEW_3_42_4').value=eedatefmt(fmtdate1,co['XLEW_3_42_4']);document.getElementById('XLEW_3_42_5').value=eedatefmt(fmtdate1,co['XLEW_3_42_5']);document.getElementById('XLEW_3_42_6').value=eedatefmt(fmtdate1,co['XLEW_3_42_6']);document.getElementById('XLEW_3_43_2').value=eedisplayFloat(co['XLEW_3_43_2']);document.getElementById('XLEW_3_43_3').value=eedisplayFloat(co['XLEW_3_43_3']);document.getElementById('XLEW_3_43_4').value=eedatefmt(fmtdate1,co['XLEW_3_43_4']);document.getElementById('XLEW_3_43_5').value=eedatefmt(fmtdate1,co['XLEW_3_43_5']);document.getElementById('XLEW_3_43_6').value=eedatefmt(fmtdate1,co['XLEW_3_43_6']);document.getElementById('XLEW_3_44_2').value=eedisplayFloat(co['XLEW_3_44_2']);document.getElementById('XLEW_3_44_3').value=eedisplayFloat(co['XLEW_3_44_3']);
document.getElementById('XLEW_3_44_4').value=eedatefmt(fmtdate1,co['XLEW_3_44_4']);document.getElementById('XLEW_3_44_5').value=eedatefmt(fmtdate1,co['XLEW_3_44_5']);document.getElementById('XLEW_3_44_6').value=eedatefmt(fmtdate1,co['XLEW_3_44_6']);document.getElementById('XLEW_3_45_2').value=eedisplayFloat(co['XLEW_3_45_2']);document.getElementById('XLEW_3_45_3').value=eedisplayFloat(co['XLEW_3_45_3']);document.getElementById('XLEW_3_45_4').value=eedatefmt(fmtdate1,co['XLEW_3_45_4']);document.getElementById('XLEW_3_45_5').value=eedatefmt(fmtdate1,co['XLEW_3_45_5']);document.getElementById('XLEW_3_45_6').value=eedatefmt(fmtdate1,co['XLEW_3_45_6']);document.getElementById('XLEW_3_46_2').value=eedisplayFloat(co['XLEW_3_46_2']);document.getElementById('XLEW_3_46_3').value=eedisplayFloat(co['XLEW_3_46_3']);document.getElementById('XLEW_3_46_4').value=eedatefmt(fmtdate1,co['XLEW_3_46_4']);document.getElementById('XLEW_3_46_5').value=eedatefmt(fmtdate1,co['XLEW_3_46_5']);document.getElementById('XLEW_3_46_6').value=eedatefmt(fmtdate1,co['XLEW_3_46_6']);document.getElementById('XLEW_3_47_2').value=eedisplayFloat(co['XLEW_3_47_2']);document.getElementById('XLEW_3_47_3').value=eedisplayFloat(co['XLEW_3_47_3']);document.getElementById('XLEW_3_47_4').value=eedatefmt(fmtdate1,co['XLEW_3_47_4']);document.getElementById('XLEW_3_47_5').value=eedatefmt(fmtdate1,co['XLEW_3_47_5']);document.getElementById('XLEW_3_47_6').value=eedatefmt(fmtdate1,co['XLEW_3_47_6']);document.getElementById('XLEW_3_48_2').value=eedisplayFloat(co['XLEW_3_48_2']);
document.getElementById('XLEW_3_48_3').value=eedisplayFloat(co['XLEW_3_48_3']);document.getElementById('XLEW_3_48_4').value=eedatefmt(fmtdate1,co['XLEW_3_48_4']);document.getElementById('XLEW_3_48_5').value=eedatefmt(fmtdate1,co['XLEW_3_48_5']);document.getElementById('XLEW_3_48_6').value=eedatefmt(fmtdate1,co['XLEW_3_48_6']);document.getElementById('XLEW_3_49_2').value=eedisplayFloat(co['XLEW_3_49_2']);document.getElementById('XLEW_3_49_3').value=eedisplayFloat(co['XLEW_3_49_3']);document.getElementById('XLEW_3_49_4').value=eedatefmt(fmtdate1,co['XLEW_3_49_4']);document.getElementById('XLEW_3_49_5').value=eedatefmt(fmtdate1,co['XLEW_3_49_5']);document.getElementById('XLEW_3_49_6').value=eedatefmt(fmtdate1,co['XLEW_3_49_6']);document.getElementById('XLEW_3_50_2').value=eedisplayFloat(co['XLEW_3_50_2']);document.getElementById('XLEW_3_50_3').value=eedisplayFloat(co['XLEW_3_50_3']);document.getElementById('XLEW_3_50_4').value=eedatefmt(fmtdate1,co['XLEW_3_50_4']);document.getElementById('XLEW_3_50_5').value=eedatefmt(fmtdate1,co['XLEW_3_50_5']);document.getElementById('XLEW_3_50_6').value=eedatefmt(fmtdate1,co['XLEW_3_50_6']);document.getElementById('XLEW_3_51_2').value=eedisplayFloat(co['XLEW_3_51_2']);document.getElementById('XLEW_3_51_3').value=eedisplayFloat(co['XLEW_3_51_3']);document.getElementById('XLEW_3_51_4').value=eedatefmt(fmtdate1,co['XLEW_3_51_4']);document.getElementById('XLEW_3_51_5').value=eedatefmt(fmtdate1,co['XLEW_3_51_5']);document.getElementById('XLEW_3_51_6').value=eedatefmt(fmtdate1,co['XLEW_3_51_6']);
document.getElementById('XLEW_3_52_2').value=eedisplayFloat(co['XLEW_3_52_2']);document.getElementById('XLEW_3_52_3').value=eedisplayFloat(co['XLEW_3_52_3']);document.getElementById('XLEW_3_52_4').value=eedatefmt(fmtdate1,co['XLEW_3_52_4']);document.getElementById('XLEW_3_52_5').value=eedatefmt(fmtdate1,co['XLEW_3_52_5']);document.getElementById('XLEW_3_52_6').value=eedatefmt(fmtdate1,co['XLEW_3_52_6']);document.getElementById('XLEW_3_53_2').value=eedisplayFloat(co['XLEW_3_53_2']);document.getElementById('XLEW_3_53_3').value=eedisplayFloat(co['XLEW_3_53_3']);document.getElementById('XLEW_3_53_4').value=eedatefmt(fmtdate1,co['XLEW_3_53_4']);document.getElementById('XLEW_3_53_5').value=eedatefmt(fmtdate1,co['XLEW_3_53_5']);document.getElementById('XLEW_3_53_6').value=eedatefmt(fmtdate1,co['XLEW_3_53_6']);document.getElementById('XLEW_3_54_2').value=eedisplayFloat(co['XLEW_3_54_2']);document.getElementById('XLEW_3_54_3').value=eedisplayFloat(co['XLEW_3_54_3']);document.getElementById('XLEW_3_54_4').value=eedatefmt(fmtdate1,co['XLEW_3_54_4']);document.getElementById('XLEW_3_54_5').value=eedatefmt(fmtdate1,co['XLEW_3_54_5']);document.getElementById('XLEW_3_54_6').value=eedatefmt(fmtdate1,co['XLEW_3_54_6']);document.getElementById('XLEW_3_55_2').value=eedisplayFloat(co['XLEW_3_55_2']);document.getElementById('XLEW_3_55_3').value=eedisplayFloat(co['XLEW_3_55_3']);document.getElementById('XLEW_3_55_4').value=eedatefmt(fmtdate1,co['XLEW_3_55_4']);document.getElementById('XLEW_3_55_5').value=eedatefmt(fmtdate1,co['XLEW_3_55_5']);
document.getElementById('XLEW_3_55_6').value=eedatefmt(fmtdate1,co['XLEW_3_55_6']);document.getElementById('XLEW_3_56_2').value=eedisplayFloat(co['XLEW_3_56_2']);document.getElementById('XLEW_3_56_3').value=eedisplayFloat(co['XLEW_3_56_3']);document.getElementById('XLEW_3_56_4').value=eedatefmt(fmtdate1,co['XLEW_3_56_4']);document.getElementById('XLEW_3_56_5').value=eedatefmt(fmtdate1,co['XLEW_3_56_5']);document.getElementById('XLEW_3_56_6').value=eedatefmt(fmtdate1,co['XLEW_3_56_6']);document.getElementById('XLEW_3_57_2').value=eedisplayFloat(co['XLEW_3_57_2']);document.getElementById('XLEW_3_57_3').value=eedisplayFloat(co['XLEW_3_57_3']);document.getElementById('XLEW_3_57_4').value=eedatefmt(fmtdate1,co['XLEW_3_57_4']);document.getElementById('XLEW_3_57_5').value=eedatefmt(fmtdate1,co['XLEW_3_57_5']);document.getElementById('XLEW_3_57_6').value=eedatefmt(fmtdate1,co['XLEW_3_57_6']);document.getElementById('XLEW_3_58_2').value=eedisplayFloat(co['XLEW_3_58_2']);document.getElementById('XLEW_3_58_3').value=eedisplayFloat(co['XLEW_3_58_3']);document.getElementById('XLEW_3_58_4').value=eedatefmt(fmtdate1,co['XLEW_3_58_4']);document.getElementById('XLEW_3_58_5').value=eedatefmt(fmtdate1,co['XLEW_3_58_5']);document.getElementById('XLEW_3_58_6').value=eedatefmt(fmtdate1,co['XLEW_3_58_6']);document.getElementById('XLEW_3_59_2').value=eedisplayFloat(co['XLEW_3_59_2']);document.getElementById('XLEW_3_59_3').value=eedisplayFloat(co['XLEW_3_59_3']);document.getElementById('XLEW_3_59_4').value=eedatefmt(fmtdate1,co['XLEW_3_59_4']);
document.getElementById('XLEW_3_59_5').value=eedatefmt(fmtdate1,co['XLEW_3_59_5']);document.getElementById('XLEW_3_59_6').value=eedatefmt(fmtdate1,co['XLEW_3_59_6']);document.getElementById('XLEW_3_60_2').value=eedisplayFloat(co['XLEW_3_60_2']);document.getElementById('XLEW_3_60_3').value=eedisplayFloat(co['XLEW_3_60_3']);document.getElementById('XLEW_3_60_4').value=eedatefmt(fmtdate1,co['XLEW_3_60_4']);document.getElementById('XLEW_3_60_5').value=eedatefmt(fmtdate1,co['XLEW_3_60_5']);document.getElementById('XLEW_3_60_6').value=eedatefmt(fmtdate1,co['XLEW_3_60_6']);document.getElementById('XLEW_3_61_2').value=eedisplayFloat(co['XLEW_3_61_2']);document.getElementById('XLEW_3_61_3').value=eedisplayFloat(co['XLEW_3_61_3']);document.getElementById('XLEW_3_61_4').value=eedatefmt(fmtdate1,co['XLEW_3_61_4']);document.getElementById('XLEW_3_61_5').value=eedatefmt(fmtdate1,co['XLEW_3_61_5']);document.getElementById('XLEW_3_61_6').value=eedatefmt(fmtdate1,co['XLEW_3_61_6']);document.getElementById('XLEW_3_62_2').value=eedisplayFloat(co['XLEW_3_62_2']);document.getElementById('XLEW_3_62_3').value=eedisplayFloat(co['XLEW_3_62_3']);document.getElementById('XLEW_3_62_4').value=eedatefmt(fmtdate1,co['XLEW_3_62_4']);document.getElementById('XLEW_3_62_5').value=eedatefmt(fmtdate1,co['XLEW_3_62_5']);document.getElementById('XLEW_3_62_6').value=eedatefmt(fmtdate1,co['XLEW_3_62_6']);document.getElementById('XLEW_3_63_2').value=eedisplayFloat(co['XLEW_3_63_2']);document.getElementById('XLEW_3_63_3').value=eedisplayFloat(co['XLEW_3_63_3']);
document.getElementById('XLEW_3_63_4').value=eedatefmt(fmtdate1,co['XLEW_3_63_4']);document.getElementById('XLEW_3_63_5').value=eedatefmt(fmtdate1,co['XLEW_3_63_5']);document.getElementById('XLEW_3_63_6').value=eedatefmt(fmtdate1,co['XLEW_3_63_6']);document.getElementById('XLEW_3_64_2').value=eedisplayFloat(co['XLEW_3_64_2']);document.getElementById('XLEW_3_64_3').value=eedisplayFloat(co['XLEW_3_64_3']);document.getElementById('XLEW_3_64_4').value=eedatefmt(fmtdate1,co['XLEW_3_64_4']);document.getElementById('XLEW_3_64_5').value=eedatefmt(fmtdate1,co['XLEW_3_64_5']);document.getElementById('XLEW_3_64_6').value=eedatefmt(fmtdate1,co['XLEW_3_64_6']);document.getElementById('XLEW_3_65_2').value=eedisplayFloat(co['XLEW_3_65_2']);document.getElementById('XLEW_3_65_3').value=eedisplayFloat(co['XLEW_3_65_3']);document.getElementById('XLEW_3_65_4').value=eedatefmt(fmtdate1,co['XLEW_3_65_4']);document.getElementById('XLEW_3_65_5').value=eedatefmt(fmtdate1,co['XLEW_3_65_5']);document.getElementById('XLEW_3_65_6').value=eedatefmt(fmtdate1,co['XLEW_3_65_6']);document.getElementById('XLEW_3_66_2').value=eedisplayFloat(co['XLEW_3_66_2']);document.getElementById('XLEW_3_66_3').value=eedisplayFloat(co['XLEW_3_66_3']);document.getElementById('XLEW_3_66_4').value=eedatefmt(fmtdate1,co['XLEW_3_66_4']);document.getElementById('XLEW_3_66_5').value=eedatefmt(fmtdate1,co['XLEW_3_66_5']);document.getElementById('XLEW_3_66_6').value=eedatefmt(fmtdate1,co['XLEW_3_66_6']);document.getElementById('XLEW_3_67_2').value=eedisplayFloat(co['XLEW_3_67_2']);
document.getElementById('XLEW_3_67_3').value=eedisplayFloat(co['XLEW_3_67_3']);document.getElementById('XLEW_3_67_4').value=eedatefmt(fmtdate1,co['XLEW_3_67_4']);document.getElementById('XLEW_3_67_5').value=eedatefmt(fmtdate1,co['XLEW_3_67_5']);document.getElementById('XLEW_3_67_6').value=eedatefmt(fmtdate1,co['XLEW_3_67_6']);document.getElementById('XLEW_3_68_2').value=eedisplayFloat(co['XLEW_3_68_2']);document.getElementById('XLEW_3_68_3').value=eedisplayFloat(co['XLEW_3_68_3']);document.getElementById('XLEW_3_68_4').value=eedatefmt(fmtdate1,co['XLEW_3_68_4']);document.getElementById('XLEW_3_68_5').value=eedatefmt(fmtdate1,co['XLEW_3_68_5']);document.getElementById('XLEW_3_68_6').value=eedatefmt(fmtdate1,co['XLEW_3_68_6']);document.getElementById('XLEW_3_69_2').value=eedisplayFloat(co['XLEW_3_69_2']);document.getElementById('XLEW_3_69_3').value=eedisplayFloat(co['XLEW_3_69_3']);document.getElementById('XLEW_3_69_4').value=eedatefmt(fmtdate1,co['XLEW_3_69_4']);document.getElementById('XLEW_3_69_5').value=eedatefmt(fmtdate1,co['XLEW_3_69_5']);document.getElementById('XLEW_3_69_6').value=eedatefmt(fmtdate1,co['XLEW_3_69_6']);document.getElementById('XLEW_3_70_2').value=eedisplayFloat(co['XLEW_3_70_2']);document.getElementById('XLEW_3_70_3').value=eedisplayFloat(co['XLEW_3_70_3']);document.getElementById('XLEW_3_70_4').value=eedatefmt(fmtdate1,co['XLEW_3_70_4']);document.getElementById('XLEW_3_70_5').value=eedatefmt(fmtdate1,co['XLEW_3_70_5']);document.getElementById('XLEW_3_70_6').value=eedatefmt(fmtdate1,co['XLEW_3_70_6']);
document.getElementById('XLEW_3_71_2').value=eedisplayFloat(co['XLEW_3_71_2']);document.getElementById('XLEW_3_71_3').value=eedisplayFloat(co['XLEW_3_71_3']);document.getElementById('XLEW_3_71_4').value=eedatefmt(fmtdate1,co['XLEW_3_71_4']);document.getElementById('XLEW_3_71_5').value=eedatefmt(fmtdate1,co['XLEW_3_71_5']);document.getElementById('XLEW_3_71_6').value=eedatefmt(fmtdate1,co['XLEW_3_71_6']);document.getElementById('XLEW_3_72_2').value=eedisplayFloat(co['XLEW_3_72_2']);document.getElementById('XLEW_3_72_3').value=eedisplayFloat(co['XLEW_3_72_3']);document.getElementById('XLEW_3_72_4').value=eedatefmt(fmtdate1,co['XLEW_3_72_4']);document.getElementById('XLEW_3_72_5').value=eedatefmt(fmtdate1,co['XLEW_3_72_5']);document.getElementById('XLEW_3_72_6').value=eedatefmt(fmtdate1,co['XLEW_3_72_6']);document.getElementById('XLEW_3_73_2').value=eedisplayFloat(co['XLEW_3_73_2']);document.getElementById('XLEW_3_73_3').value=eedisplayFloat(co['XLEW_3_73_3']);document.getElementById('XLEW_3_73_4').value=eedatefmt(fmtdate1,co['XLEW_3_73_4']);document.getElementById('XLEW_3_73_5').value=eedatefmt(fmtdate1,co['XLEW_3_73_5']);document.getElementById('XLEW_3_73_6').value=eedatefmt(fmtdate1,co['XLEW_3_73_6']);
};
EE.UpdateWidgets();};
...
var dynamicDropdown = function(data){					
					console.log(data.id + ' needs to be re-populated');
					var currentVal = $('#'+data.id).find(':selected').val();
					console.log('current value is ' + currentVal);
					var option_exists = false;
					
					$('#'+data.id).empty();
					
					var type = data.sa2.arr[0][0];
					var pos = data.sa2.arr[0][1];
					var match = data.sa2.arr[0][2];
					
					if(type == 'matching'){																
						if(pos == 'firstcolumn'){  /* look up for match in first column */
							$.each(data.sa1.arr, function(index, items) {			
								if(items[0] == data.s1){
									$.each(items.slice(1),function(subindex, subitem){
										if(subitem == '') return;
										if(currentVal == subitem) option_exists = true;
										$('#'+data.id).append( $('<option></option>').attr('data-value','s:'+subitem).html(subitem));//.attr('selected', subindex == 0) )
										console.log('added ');
									});
								}
							});									
						}else { /* look up for match in first row */
							$.each(data.sa1.arr[0], function(index, item){ 
								if(item == data.s1) { 
									$.each(data.sa1.arr.slice(1), function(subindex, subitem){ 											
										if(subitem[index] == '') return;
                                        if(currentVal == subitem[index]) option_exists = true;
										$('#'+data.id).append( $('<option></option>').attr('data-value','s:'+subitem[index]).html(subitem[index]));//.attr('selected', subindex == 0))
										console.log('added ');												
									});
								}
							});								
						}
					}else{ /* fixed row or column */
						$.each(data.sa1.arr, function(index, item) {	
						   $.each(item, function (subindex, subitem){
								if(subitem == '') return;
                                if(currentVal == subitem) option_exists = true;
								$('#'+data.id).append( $('<option></option>').attr('data-value','s:'+subitem).html(subitem));//.attr('selected', index == 0 && subindex == 0) )
								console.log('added ');
							});
						});
					}
				    console.log('option exists: ' + option_exists);
					if(option_exists) $('#'+data.id).val(currentVal); else  $('#'+data.id).find('option:first-child').attr('selected', 'selected');
                   $('#'+data.id).selectmenu('refresh');

					if(!option_exists){
                        EE.eeRecalcNeeded = true;
						//console.log(data.id + ' triggered recalc');
						//recalc_onclick('');
					}
				};
